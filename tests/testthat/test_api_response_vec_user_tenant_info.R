...
context("Test ApiResponseVecUserTenantInfo")

model_instance <- ApiResponseVecUserTenantInfo$new()

test_that("data", {
  # tests for the property `data` (array[ApiResponseVecUserTenantInfoDataInner])
