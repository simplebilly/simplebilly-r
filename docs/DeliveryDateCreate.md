...
**orderNumber** | **character** | Sales order number (&#x60;order.order_number&#x60;). | 
...
**promisedDate** | **character** | Date promised to the customer. | 
**status** | [**DeliveryDateStatus**](DeliveryDateStatus.md) | One of: promised | confirmed | rescheduled | fulfilled | late | cancelled | [Enum: ] 
