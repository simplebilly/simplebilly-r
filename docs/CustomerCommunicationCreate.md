# openapi::CustomerCommunicationCreate
...
**channel** | [**CommunicationChannel**](CommunicationChannel.md) |  | [Enum: ] 
**contactId** | **character** | The contact (customer/supplier) this communication belongs to. References the contact entity. | 
**counterparty** | **character** | Email/phone of the counterparty, if applicable. | [optional] 
**direction** | [**CommunicationDirection**](CommunicationDirection.md) |  | [Enum: ] 
