# openapi::SupplierConditionCreate


## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**currency** | **character** | Currency for the minimum order value. | [Max. length: 3] [Min. length: 3] 
...
**supplierContactId** | **character** | The supplier this condition applies to (&#x60;contact_id&#x60;). References the supplier entity. | 
