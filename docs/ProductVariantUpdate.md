...
**productId** | **character** | The parent product this variant belongs to. References the product entity. | [optional] 
**sku** | **character** | Variant-specific SKU (must be unique per tenant). | [optional] 
