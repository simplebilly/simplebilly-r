...
------------ | ------------- | ------------- | -------------
**activityType** | [**ActivityType**](ActivityType.md) | One of: call | email | meeting | task | note | [optional] [Enum: ] 
...
**status** | [**ActivityStatus**](ActivityStatus.md) | One of: open | done | cancelled | [optional] [Enum: ] 
**subject** | **character** | Short subject line. | [optional] 
