#' Create a new JobPostingUpdate
#'
#' @description
#' JobPostingUpdate Class
#'
#' @docType class
#' @title JobPostingUpdate
#' @description JobPostingUpdate Class
#' @format An \code{R6Class} generator object
#' @field currency  character [optional]
#' @field department  character [optional]
#' @field description What the job is; markdown/HTML. character [optional]
...
#' @field remote  character [optional]
#' @field requiredSkills List of required skill names (JSON array of strings). \link{AnyType} [optional]
...
#' @field status draft | published | closed \link{JobPostingStatus} [optional]
#' @field title  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
JobPostingUpdate <- R6::R6Class(
  "JobPostingUpdate",
  public = list(
    `currency` = NULL,
    `department` = NULL,
    ...
    #' @description
    #' Initialize a new JobPostingUpdate class.
    #'
    ...
    initialize = function(`currency` = NULL, `department` = NULL, `description` = NULL, `employmentType` = NULL, `location` = NULL, `remote` = NULL, `requiredSkills` = NULL, `requirements` = NULL, `salaryMax` = NULL, `salaryMin` = NULL, `status` = NULL, `title` = NULL, ...) {
      if (!is.null(`currency`)) {
    ...
    #'
    #' @return JobPostingUpdate as a base R list.
    #' @examples
    #' # convert array of JobPostingUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert JobPostingUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      JobPostingUpdateObject <- list()
      if (!is.null(self$`currency`)) {
        JobPostingUpdateObject[["currency"]] <-
          self$`currency`
      }
      if (!is.null(self$`department`)) {
        JobPostingUpdateObject[["department"]] <-
          self$`department`
      }
      if (!is.null(self$`description`)) {
        JobPostingUpdateObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`employmentType`)) {
        JobPostingUpdateObject[["employmentType"]] <-
          self$extractSimpleType(self$`employmentType`)
      }
      if (!is.null(self$`location`)) {
        JobPostingUpdateObject[["location"]] <-
          self$`location`
      }
      if (!is.null(self$`remote`)) {
        JobPostingUpdateObject[["remote"]] <-
          self$`remote`
      }
      if (!is.null(self$`requiredSkills`)) {
        JobPostingUpdateObject[["requiredSkills"]] <-
          self$extractSimpleType(self$`requiredSkills`)
      }
      if (!is.null(self$`requirements`)) {
        JobPostingUpdateObject[["requirements"]] <-
          self$`requirements`
      }
      if (!is.null(self$`salaryMax`)) {
        JobPostingUpdateObject[["salaryMax"]] <-
          self$`salaryMax`
      }
      if (!is.null(self$`salaryMin`)) {
        JobPostingUpdateObject[["salaryMin"]] <-
          self$`salaryMin`
      }
      if (!is.null(self$`status`)) {
        JobPostingUpdateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`title`)) {
        JobPostingUpdateObject[["title"]] <-
          self$`title`
      }
      return(JobPostingUpdateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of JobPostingUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of JobPostingUpdate
    ...
    #' @return JobPostingUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to JobPostingUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of JobPostingUpdate
    toString = function() {
      self$toJSONString()
    },
...
# JobPostingUpdate$unlock()
#
## Below is an example to define the print function
# JobPostingUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# JobPostingUpdate$lock()
