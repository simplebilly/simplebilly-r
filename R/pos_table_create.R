#' Create a new PosTableCreate
#'
#' @description
#' PosTableCreate Class
#'
#' @docType class
#' @title PosTableCreate
#' @description PosTableCreate Class
...
PosTableCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PosTableCreate class.
    #'
    #' @param name name
    ...
    #'
    #' @return PosTableCreate as a base R list.
    #' @examples
    #' # convert array of PosTableCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PosTableCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PosTableCreateObject <- list()
      if (!is.null(self$`currentOrderNumber`)) {
        PosTableCreateObject[["currentOrderNumber"]] <-
          self$`currentOrderNumber`
      }
      if (!is.null(self$`name`)) {
        PosTableCreateObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`status`)) {
        PosTableCreateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      return(PosTableCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PosTableCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of PosTableCreate
    ...
    #' @return PosTableCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PosTableCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PosTableCreate: the required field `name` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PosTableCreate
    toString = function() {
      self$toJSONString()
    },
...
# PosTableCreate$unlock()
#
## Below is an example to define the print function
# PosTableCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
