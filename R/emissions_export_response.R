#' Create a new EmissionsExportResponse
#'
#' @description
#' EmissionsExportResponse Class
#'
#' @docType class
#' @title EmissionsExportResponse
#' @description EmissionsExportResponse Class
...
#' @export
EmissionsExportResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new EmissionsExportResponse class.
    #'
    ...
    #'
    #' @return EmissionsExportResponse as a base R list.
    #' @examples
    #' # convert array of EmissionsExportResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert EmissionsExportResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      EmissionsExportResponseObject <- list()
      if (!is.null(self$`csv_content`)) {
        EmissionsExportResponseObject[["csv_content"]] <-
          self$`csv_content`
      }
      if (!is.null(self$`filename`)) {
        EmissionsExportResponseObject[["filename"]] <-
          self$`filename`
      }
      return(EmissionsExportResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of EmissionsExportResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of EmissionsExportResponse
    ...
    #' @return EmissionsExportResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to EmissionsExportResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`csv_content`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EmissionsExportResponse: the required field `csv_content` is missing."))
      }
      ...
      if (!is.null(input_json$`filename`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for EmissionsExportResponse: the required field `filename` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of EmissionsExportResponse
    toString = function() {
      self$toJSONString()
    },
...
# EmissionsExportResponse$unlock()
#
## Below is an example to define the print function
# EmissionsExportResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# EmissionsExportResponse$lock()
