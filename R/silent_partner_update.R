#' Create a new SilentPartnerUpdate
#'
#' @description
#' SilentPartnerUpdate Class
#'
#' @docType class
#' @title SilentPartnerUpdate
#' @description SilentPartnerUpdate Class
...
#' @field instrumentType Instrument: \"typisch\" | \"atypisch\" | \"partiarisches_darlehen\" | \"genussrecht\". \link{InstrumentType} [optional]
...
#' @export
SilentPartnerUpdate <- R6::R6Class(
  "SilentPartnerUpdate",
  public = list(
    `contractDate` = NULL,
    `einlage` = NULL,
    ...
    #' @description
    #' Initialize a new SilentPartnerUpdate class.
    #'
    ...
    initialize = function(`contractDate` = NULL, `einlage` = NULL, `gewinnquotePct` = NULL, `gewinnvortrag` = NULL, `instrumentType` = NULL, `kestPflichtig` = NULL, `name` = NULL, `notes` = NULL, `verlustVerrechnungskonto` = NULL, `verlustbeteiligung` = NULL, ...) {
    ...
    #'
    #' @return SilentPartnerUpdate as a base R list.
    #' @examples
    #' # convert array of SilentPartnerUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SilentPartnerUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SilentPartnerUpdateObject <- list()
      if (!is.null(self$`contractDate`)) {
        SilentPartnerUpdateObject[["contractDate"]] <-
          self$`contractDate`
      }
      if (!is.null(self$`einlage`)) {
        SilentPartnerUpdateObject[["einlage"]] <-
          self$`einlage`
      }
      if (!is.null(self$`gewinnquotePct`)) {
        SilentPartnerUpdateObject[["gewinnquotePct"]] <-
          self$`gewinnquotePct`
      }
      if (!is.null(self$`gewinnvortrag`)) {
        SilentPartnerUpdateObject[["gewinnvortrag"]] <-
          self$`gewinnvortrag`
      }
      if (!is.null(self$`instrumentType`)) {
        SilentPartnerUpdateObject[["instrumentType"]] <-
          self$extractSimpleType(self$`instrumentType`)
      }
      if (!is.null(self$`kestPflichtig`)) {
        SilentPartnerUpdateObject[["kestPflichtig"]] <-
          self$`kestPflichtig`
      }
      if (!is.null(self$`name`)) {
        SilentPartnerUpdateObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`notes`)) {
        SilentPartnerUpdateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`verlustVerrechnungskonto`)) {
        SilentPartnerUpdateObject[["verlustVerrechnungskonto"]] <-
          self$`verlustVerrechnungskonto`
      }
      if (!is.null(self$`verlustbeteiligung`)) {
        SilentPartnerUpdateObject[["verlustbeteiligung"]] <-
          self$`verlustbeteiligung`
      }
      return(SilentPartnerUpdateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of SilentPartnerUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of SilentPartnerUpdate
    ...
    #' @return SilentPartnerUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SilentPartnerUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SilentPartnerUpdate
    toString = function() {
      self$toJSONString()
    },
...
# SilentPartnerUpdate$unlock()
#
## Below is an example to define the print function
# SilentPartnerUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SilentPartnerUpdate$lock()
