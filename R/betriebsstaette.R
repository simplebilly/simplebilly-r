...
#'
#' @docType class
#' @title Betriebsstaette
#' @description Betriebsstaette Class
...
Betriebsstaette <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Betriebsstaette class.
    #'
    #' @param beschaefigte beschaefigte
    #' @param name name
    #' @param ... Other optional arguments.
    initialize = function(`beschaefigte`, `name`, ...) {
    ...
    #'
    #' @return Betriebsstaette as a base R list.
    #' @examples
    #' # convert array of Betriebsstaette (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert Betriebsstaette to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BetriebsstaetteObject <- list()
      if (!is.null(self$`beschaefigte`)) {
        BetriebsstaetteObject[["beschaefigte"]] <-
          self$`beschaefigte`
      }
      if (!is.null(self$`name`)) {
        BetriebsstaetteObject[["name"]] <-
          self$`name`
      }
      return(BetriebsstaetteObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of Betriebsstaette
    #'
    #' @param input_json the JSON input
    #' @return the instance of Betriebsstaette
    ...
    #' @return Betriebsstaette in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to Betriebsstaette and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`beschaefigte`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Betriebsstaette: the required field `beschaefigte` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Betriebsstaette: the required field `name` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of Betriebsstaette
    toString = function() {
      self$toJSONString()
    },
...
# Betriebsstaette$unlock()
#
## Below is an example to define the print function
# Betriebsstaette$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# Betriebsstaette$lock()
