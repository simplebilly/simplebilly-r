...
UserProfile <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UserProfile class.
    #'
    ...
    #'
    #' @return UserProfile as a base R list.
    #' @examples
    #' # convert array of UserProfile (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UserProfile to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UserProfileObject <- list()
      if (!is.null(self$`created_at`)) {
        UserProfileObject[["created_at"]] <-
          self$`created_at`
      }
      ...
      if (!is.null(self$`email_verified`)) {
        UserProfileObject[["email_verified"]] <-
          self$`email_verified`
      }
      if (!is.null(self$`first_name`)) {
        UserProfileObject[["first_name"]] <-
          self$`first_name`
      }
      if (!is.null(self$`full_name`)) {
        UserProfileObject[["full_name"]] <-
          self$`full_name`
      }
      if (!is.null(self$`id`)) {
        UserProfileObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`last_name`)) {
        UserProfileObject[["last_name"]] <-
          self$`last_name`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of UserProfile
    #'
    #' @param input_json the JSON input
    #' @return the instance of UserProfile
    ...
    #' @description
    #' Validate JSON input with respect to UserProfile and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`created_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserProfile: the required field `created_at` is missing."))
      }
      ...
      if (!is.null(input_json$`email`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserProfile: the required field `email` is missing."))
      }
      ...
      if (!is.null(input_json$`email_verified`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserProfile: the required field `email_verified` is missing."))
      }
      ...
      if (!is.null(input_json$`first_name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserProfile: the required field `first_name` is missing."))
      }
      ...
      if (!is.null(input_json$`full_name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserProfile: the required field `full_name` is missing."))
      }
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserProfile: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserProfile: the required field `last_name` is missing."))
      }
    },
...
# UserProfile$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
