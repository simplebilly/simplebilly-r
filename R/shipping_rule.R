...
#' @docType class
#' @title ShippingRule
#' @description ShippingRule Class
...
ShippingRule <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ShippingRule class.
    #'
    ...
    #'
    #' @return ShippingRule as a base R list.
    #' @examples
    #' # convert array of ShippingRule (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ShippingRule to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ShippingRuleObject <- list()
      if (!is.null(self$`carrier`)) {
        ShippingRuleObject[["carrier"]] <-
          self$`carrier`
      }
      if (!is.null(self$`country`)) {
        ShippingRuleObject[["country"]] <-
          self$extractSimpleType(self$`country`)
      }
      if (!is.null(self$`deliveryTime`)) {
        ShippingRuleObject[["deliveryTime"]] <-
          self$`deliveryTime`
      }
      if (!is.null(self$`isActive`)) {
        ShippingRuleObject[["isActive"]] <-
          self$`isActive`
      }
      if (!is.null(self$`maxWeightKg`)) {
        ShippingRuleObject[["maxWeightKg"]] <-
          self$`maxWeightKg`
      }
      if (!is.null(self$`minWeightKg`)) {
        ShippingRuleObject[["minWeightKg"]] <-
          self$`minWeightKg`
      }
      if (!is.null(self$`name`)) {
        ShippingRuleObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`notes`)) {
        ShippingRuleObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`price`)) {
        ShippingRuleObject[["price"]] <-
          self$`price`
      }
      if (!is.null(self$`priority`)) {
        ShippingRuleObject[["priority"]] <-
          self$`priority`
      }
      return(ShippingRuleObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ShippingRule
    #'
    #' @param input_json the JSON input
    #' @return the instance of ShippingRule
    ...
    #' @return ShippingRule in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ShippingRule and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShippingRule: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`price`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ShippingRule: the required field `price` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ShippingRule
    toString = function() {
      self$toJSONString()
    },
...
# ShippingRule$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
