#' Create a new ApiResponseSubscriptionOverviewData
#'
#' @description
...
#'
#' @docType class
#' @title ApiResponseSubscriptionOverviewData
#' @description ApiResponseSubscriptionOverviewData Class
...
#' @export
ApiResponseSubscriptionOverviewData <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ApiResponseSubscriptionOverviewData class.
    #'
    ...
    #'
    #' @return ApiResponseSubscriptionOverviewData as a base R list.
    #' @examples
    #' # convert array of ApiResponseSubscriptionOverviewData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ApiResponseSubscriptionOverviewData to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ApiResponseSubscriptionOverviewDataObject <- list()
      if (!is.null(self$`currentPeriodEnd`)) {
        ApiResponseSubscriptionOverviewDataObject[["currentPeriodEnd"]] <-
          self$`currentPeriodEnd`
      }
      if (!is.null(self$`features`)) {
        ApiResponseSubscriptionOverviewDataObject[["features"]] <-
          self$extractSimpleType(self$`features`)
      }
      if (!is.null(self$`isTrialing`)) {
        ApiResponseSubscriptionOverviewDataObject[["isTrialing"]] <-
          self$`isTrialing`
      }
      if (!is.null(self$`limits`)) {
        ApiResponseSubscriptionOverviewDataObject[["limits"]] <-
          self$extractSimpleType(self$`limits`)
      }
      if (!is.null(self$`manageUrl`)) {
        ApiResponseSubscriptionOverviewDataObject[["manageUrl"]] <-
          self$`manageUrl`
      }
      if (!is.null(self$`plan`)) {
        ApiResponseSubscriptionOverviewDataObject[["plan"]] <-
          self$`plan`
      }
      if (!is.null(self$`planName`)) {
        ApiResponseSubscriptionOverviewDataObject[["planName"]] <-
          self$`planName`
      }
      if (!is.null(self$`priceEur`)) {
        ApiResponseSubscriptionOverviewDataObject[["priceEur"]] <-
          self$`priceEur`
      }
      if (!is.null(self$`quantity`)) {
        ApiResponseSubscriptionOverviewDataObject[["quantity"]] <-
          self$`quantity`
      }
      if (!is.null(self$`status`)) {
        ApiResponseSubscriptionOverviewDataObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`subscriptionId`)) {
        ApiResponseSubscriptionOverviewDataObject[["subscriptionId"]] <-
          self$`subscriptionId`
      }
      if (!is.null(self$`trialEndsAt`)) {
        ApiResponseSubscriptionOverviewDataObject[["trialEndsAt"]] <-
          self$`trialEndsAt`
      }
      if (!is.null(self$`usage`)) {
        ApiResponseSubscriptionOverviewDataObject[["usage"]] <-
          self$extractSimpleType(self$`usage`)
      }
      return(ApiResponseSubscriptionOverviewDataObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ApiResponseSubscriptionOverviewData
    #'
    #' @param input_json the JSON input
    #' @return the instance of ApiResponseSubscriptionOverviewData
    ...
    #' @return ApiResponseSubscriptionOverviewData in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ApiResponseSubscriptionOverviewData and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`features`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseSubscriptionOverviewData: the required field `features` is missing."))
      }
      ...
      if (!is.null(input_json$`isTrialing`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseSubscriptionOverviewData: the required field `isTrialing` is missing."))
      }
      # check the required field `limits`
      if (!is.null(input_json$`limits`)) {
        stopifnot(R6::is.R6(input_json$`limits`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseSubscriptionOverviewData: the required field `limits` is missing."))
      }
      ...
      if (!is.null(input_json$`plan`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseSubscriptionOverviewData: the required field `plan` is missing."))
      }
      ...
      if (!is.null(input_json$`planName`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseSubscriptionOverviewData: the required field `planName` is missing."))
      }
      ...
      if (!is.null(input_json$`priceEur`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseSubscriptionOverviewData: the required field `priceEur` is missing."))
      }
      # check the required field `usage`
      if (!is.null(input_json$`usage`)) {
        stopifnot(R6::is.R6(input_json$`usage`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseSubscriptionOverviewData: the required field `usage` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ApiResponseSubscriptionOverviewData
    toString = function() {
      self$toJSONString()
    },
...
# ApiResponseSubscriptionOverviewData$unlock()
#
## Below is an example to define the print function
# ApiResponseSubscriptionOverviewData$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ApiResponseSubscriptionOverviewData$lock()
