...
#' @docType class
#' @title SilentPartner
#' @description SilentPartner Class
...
SilentPartner <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new SilentPartner class.
    #'
    ...
    #'
    #' @return SilentPartner as a base R list.
    #' @examples
    #' # convert array of SilentPartner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SilentPartner to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SilentPartnerObject <- list()
      if (!is.null(self$`contractDate`)) {
        SilentPartnerObject[["contractDate"]] <-
          self$`contractDate`
      }
      if (!is.null(self$`einlage`)) {
        SilentPartnerObject[["einlage"]] <-
          self$`einlage`
      }
      if (!is.null(self$`gewinnquotePct`)) {
        SilentPartnerObject[["gewinnquotePct"]] <-
          self$`gewinnquotePct`
      }
      if (!is.null(self$`gewinnvortrag`)) {
        SilentPartnerObject[["gewinnvortrag"]] <-
          self$`gewinnvortrag`
      }
      if (!is.null(self$`instrumentType`)) {
        SilentPartnerObject[["instrumentType"]] <-
          self$extractSimpleType(self$`instrumentType`)
      }
      if (!is.null(self$`kestPflichtig`)) {
        SilentPartnerObject[["kestPflichtig"]] <-
          self$`kestPflichtig`
      }
      if (!is.null(self$`name`)) {
        SilentPartnerObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`notes`)) {
        SilentPartnerObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`verlustVerrechnungskonto`)) {
        SilentPartnerObject[["verlustVerrechnungskonto"]] <-
          self$`verlustVerrechnungskonto`
      }
      if (!is.null(self$`verlustbeteiligung`)) {
        SilentPartnerObject[["verlustbeteiligung"]] <-
          self$`verlustbeteiligung`
      }
      return(SilentPartnerObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of SilentPartner
    #'
    #' @param input_json the JSON input
    #' @return the instance of SilentPartner
    ...
    #' @return SilentPartner in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SilentPartner and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`instrumentType`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SilentPartner: the required field `instrumentType` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of SilentPartner
    toString = function() {
      self$toJSONString()
    },
...
# SilentPartner$unlock()
#
## Below is an example to define the print function
# SilentPartner$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
