#' Create a new ServiceJobUpdate
#'
#' @description
#' ServiceJobUpdate Class
#'
#' @docType class
#' @title ServiceJobUpdate
#' @description ServiceJobUpdate Class
...
ServiceJobUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ServiceJobUpdate class.
    #'
    ...
    #'
    #' @return ServiceJobUpdate as a base R list.
    #' @examples
    #' # convert array of ServiceJobUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ServiceJobUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ServiceJobUpdateObject <- list()
      if (!is.null(self$`address`)) {
        ServiceJobUpdateObject[["address"]] <-
          self$`address`
      }
      if (!is.null(self$`customerEmail`)) {
        ServiceJobUpdateObject[["customerEmail"]] <-
          self$`customerEmail`
      }
      if (!is.null(self$`customerId`)) {
        ServiceJobUpdateObject[["customerId"]] <-
          self$`customerId`
      }
      if (!is.null(self$`customerName`)) {
        ServiceJobUpdateObject[["customerName"]] <-
          self$`customerName`
      }
      if (!is.null(self$`customerPhone`)) {
        ServiceJobUpdateObject[["customerPhone"]] <-
          self$`customerPhone`
      }
      if (!is.null(self$`description`)) {
        ServiceJobUpdateObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`estimatedDurationMinutes`)) {
        ServiceJobUpdateObject[["estimatedDurationMinutes"]] <-
          self$`estimatedDurationMinutes`
      }
      if (!is.null(self$`lat`)) {
        ServiceJobUpdateObject[["lat"]] <-
          self$`lat`
      }
      if (!is.null(self$`lng`)) {
        ServiceJobUpdateObject[["lng"]] <-
          self$`lng`
      }
      if (!is.null(self$`notes`)) {
        ServiceJobUpdateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`status`)) {
        ServiceJobUpdateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      return(ServiceJobUpdateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ServiceJobUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ServiceJobUpdate
    ...
    #' @return ServiceJobUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ServiceJobUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ServiceJobUpdate
    toString = function() {
      self$toJSONString()
    },
...
# ServiceJobUpdate$unlock()
#
## Below is an example to define the print function
# ServiceJobUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ServiceJobUpdate$lock()
