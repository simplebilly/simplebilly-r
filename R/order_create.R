...
OrderCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OrderCreate class.
    #'
    ...
    #'
    #' @return OrderCreate as a base R list.
    #' @examples
    #' # convert array of OrderCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of OrderCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of OrderCreate
    ...
    #' @return OrderCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OrderCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`currency`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `currency` is missing."))
      }
      ...
      if (!is.null(input_json$`customerId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `customerId` is missing."))
      }
      # check the required field `orderStatus`
      if (!is.null(input_json$`orderStatus`)) {
        stopifnot(R6::is.R6(input_json$`orderStatus`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `orderStatus` is missing."))
      }
      # check the required field `paymentMethod`
      if (!is.null(input_json$`paymentMethod`)) {
        stopifnot(R6::is.R6(input_json$`paymentMethod`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `paymentMethod` is missing."))
      }
      ...
      if (!is.null(input_json$`shippingCost`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `shippingCost` is missing."))
      }
      ...
      if (!is.null(input_json$`shippingMethod`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `shippingMethod` is missing."))
      }
      ...
      if (!is.null(input_json$`shippingWeight`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `shippingWeight` is missing."))
      }
      ...
      if (!is.null(input_json$`tags`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `tags` is missing."))
      }
      ...
      if (!is.null(input_json$`totalCost`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrderCreate: the required field `totalCost` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of OrderCreate
    toString = function() {
      self$toJSONString()
    },
...
# OrderCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
