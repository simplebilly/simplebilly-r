...
#' @docType class
#' @title ContactUpdate
#' @description ContactUpdate Class
...
#' @field contactType  \link{ContactType} [optional]
...
ContactUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ContactUpdate class.
    #'
    ...
    #'
    #' @return ContactUpdate as a base R list.
    #' @examples
    #' # convert array of ContactUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of ContactUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ContactUpdate
    ...
    #' @return ContactUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ContactUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ContactUpdate
    toString = function() {
      self$toJSONString()
    },
...
# ContactUpdate$unlock()
#
## Below is an example to define the print function
# ContactUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
