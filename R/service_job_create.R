#' Create a new ServiceJobCreate
#'
#' @description
#' ServiceJobCreate Class
#'
#' @docType class
#' @title ServiceJobCreate
#' @description ServiceJobCreate Class
...
ServiceJobCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ServiceJobCreate class.
    #'
    ...
    #'
    #' @return ServiceJobCreate as a base R list.
    #' @examples
    #' # convert array of ServiceJobCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ServiceJobCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ServiceJobCreateObject <- list()
      if (!is.null(self$`address`)) {
        ServiceJobCreateObject[["address"]] <-
          self$`address`
      }
      if (!is.null(self$`customerEmail`)) {
        ServiceJobCreateObject[["customerEmail"]] <-
          self$`customerEmail`
      }
      if (!is.null(self$`customerId`)) {
        ServiceJobCreateObject[["customerId"]] <-
          self$`customerId`
      }
      if (!is.null(self$`customerName`)) {
        ServiceJobCreateObject[["customerName"]] <-
          self$`customerName`
      }
      if (!is.null(self$`customerPhone`)) {
        ServiceJobCreateObject[["customerPhone"]] <-
          self$`customerPhone`
      }
      if (!is.null(self$`description`)) {
        ServiceJobCreateObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`estimatedDurationMinutes`)) {
        ServiceJobCreateObject[["estimatedDurationMinutes"]] <-
          self$`estimatedDurationMinutes`
      }
      if (!is.null(self$`lat`)) {
        ServiceJobCreateObject[["lat"]] <-
          self$`lat`
      }
      if (!is.null(self$`lng`)) {
        ServiceJobCreateObject[["lng"]] <-
          self$`lng`
      }
      if (!is.null(self$`notes`)) {
        ServiceJobCreateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`status`)) {
        ServiceJobCreateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      return(ServiceJobCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ServiceJobCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ServiceJobCreate
    ...
    #' @return ServiceJobCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ServiceJobCreate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ServiceJobCreate
    toString = function() {
      self$toJSONString()
    },
...
# ServiceJobCreate$unlock()
#
## Below is an example to define the print function
# ServiceJobCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ServiceJobCreate$lock()
