...
#' @docType class
#' @title DeliveryDate
#' @description DeliveryDate Class
...
DeliveryDate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DeliveryDate class.
    #'
    ...
    #'
    #' @return DeliveryDate as a base R list.
    #' @examples
    #' # convert array of DeliveryDate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeliveryDate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeliveryDateObject <- list()
      if (!is.null(self$`customerId`)) {
        DeliveryDateObject[["customerId"]] <-
          self$`customerId`
      }
      if (!is.null(self$`fulfilledDate`)) {
        DeliveryDateObject[["fulfilledDate"]] <-
          self$`fulfilledDate`
      }
      if (!is.null(self$`note`)) {
        DeliveryDateObject[["note"]] <-
          self$`note`
      }
      if (!is.null(self$`orderNumber`)) {
        DeliveryDateObject[["orderNumber"]] <-
          self$`orderNumber`
      }
      if (!is.null(self$`originalDate`)) {
        DeliveryDateObject[["originalDate"]] <-
          self$`originalDate`
      }
      if (!is.null(self$`productId`)) {
        DeliveryDateObject[["productId"]] <-
          self$`productId`
      }
      if (!is.null(self$`promisedDate`)) {
        DeliveryDateObject[["promisedDate"]] <-
          self$`promisedDate`
      }
      if (!is.null(self$`status`)) {
        DeliveryDateObject[["status"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of DeliveryDate
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeliveryDate
    ...
    #' @return DeliveryDate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DeliveryDate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`orderNumber`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryDate: the required field `orderNumber` is missing."))
      }
      ...
      if (!is.null(input_json$`promisedDate`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryDate: the required field `promisedDate` is missing."))
      }
      # check the required field `status`
      if (!is.null(input_json$`status`)) {
        stopifnot(R6::is.R6(input_json$`status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for DeliveryDate: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DeliveryDate
    toString = function() {
      self$toJSONString()
    },
...
# DeliveryDate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
