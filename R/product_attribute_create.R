#' Create a new ProductAttributeCreate
#'
#' @description
#' ProductAttributeCreate Class
#'
#' @docType class
#' @title ProductAttributeCreate
#' @description ProductAttributeCreate Class
...
#' @export
ProductAttributeCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProductAttributeCreate class.
    #'
    ...
    #'
    #' @return ProductAttributeCreate as a base R list.
    #' @examples
    #' # convert array of ProductAttributeCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductAttributeCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProductAttributeCreateObject <- list()
      if (!is.null(self$`isFilterable`)) {
        ProductAttributeCreateObject[["isFilterable"]] <-
          self$`isFilterable`
      }
      if (!is.null(self$`name`)) {
        ProductAttributeCreateObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`position`)) {
        ProductAttributeCreateObject[["position"]] <-
          self$`position`
      }
      if (!is.null(self$`productId`)) {
        ProductAttributeCreateObject[["productId"]] <-
          self$`productId`
      }
      if (!is.null(self$`unit`)) {
        ProductAttributeCreateObject[["unit"]] <-
          self$`unit`
      }
      if (!is.null(self$`value`)) {
        ProductAttributeCreateObject[["value"]] <-
          self$`value`
      }
      return(ProductAttributeCreateObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ProductAttributeCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProductAttributeCreate
    ...
    #' @return ProductAttributeCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProductAttributeCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductAttributeCreate: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`productId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductAttributeCreate: the required field `productId` is missing."))
      }
      ...
      if (!is.null(input_json$`value`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductAttributeCreate: the required field `value` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProductAttributeCreate
    toString = function() {
      self$toJSONString()
    },
...
# ProductAttributeCreate$unlock()
#
## Below is an example to define the print function
# ProductAttributeCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProductAttributeCreate$lock()
