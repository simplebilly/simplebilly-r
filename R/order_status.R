...
# add to utils.R
.parse_OrderStatus <- function(vals) {
  res <- gsub("^\\[|\\]$", "", "[pending, ordered, confirmed, processing, paid, shipped, completed, closed, cancelled, refunded, failed]")
  unlist(strsplit(res, ", "))
}
