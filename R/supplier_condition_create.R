#' Create a new SupplierConditionCreate
#'
#' @description
#' SupplierConditionCreate Class
#'
#' @docType class
#' @title SupplierConditionCreate
#' @description SupplierConditionCreate Class
...
#' @export
SupplierConditionCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new SupplierConditionCreate class.
    #'
    ...
    #'
    #' @return SupplierConditionCreate as a base R list.
    #' @examples
    #' # convert array of SupplierConditionCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SupplierConditionCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SupplierConditionCreateObject <- list()
      if (!is.null(self$`currency`)) {
        SupplierConditionCreateObject[["currency"]] <-
          self$`currency`
      }
      if (!is.null(self$`deliveryTerms`)) {
        SupplierConditionCreateObject[["deliveryTerms"]] <-
          self$`deliveryTerms`
      }
      if (!is.null(self$`earlyPaymentDiscountPercent`)) {
        SupplierConditionCreateObject[["earlyPaymentDiscountPercent"]] <-
          self$`earlyPaymentDiscountPercent`
      }
      if (!is.null(self$`isDefault`)) {
        SupplierConditionCreateObject[["isDefault"]] <-
          self$`isDefault`
      }
      if (!is.null(self$`minimumOrderValue`)) {
        SupplierConditionCreateObject[["minimumOrderValue"]] <-
          self$`minimumOrderValue`
      }
      if (!is.null(self$`notes`)) {
        SupplierConditionCreateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`paymentDueDays`)) {
        SupplierConditionCreateObject[["paymentDueDays"]] <-
          self$`paymentDueDays`
      }
      if (!is.null(self$`paymentTerms`)) {
        SupplierConditionCreateObject[["paymentTerms"]] <-
          self$`paymentTerms`
      }
      if (!is.null(self$`supplierContactId`)) {
        SupplierConditionCreateObject[["supplierContactId"]] <-
          self$`supplierContactId`
      }
      if (!is.null(self$`supplierName`)) {
        SupplierConditionCreateObject[["supplierName"]] <-
          self$`supplierName`
      }
      if (!is.null(self$`volumeDiscountTiers`)) {
        SupplierConditionCreateObject[["volumeDiscountTiers"]] <-
          self$extractSimpleType(self$`volumeDiscountTiers`)
      }
      return(SupplierConditionCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of SupplierConditionCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of SupplierConditionCreate
    ...
    #' @return SupplierConditionCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SupplierConditionCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`currency`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SupplierConditionCreate: the required field `currency` is missing."))
      }
      ...
      if (!is.null(input_json$`supplierContactId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SupplierConditionCreate: the required field `supplierContactId` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of SupplierConditionCreate
    toString = function() {
      self$toJSONString()
    },
...
# SupplierConditionCreate$unlock()
#
## Below is an example to define the print function
# SupplierConditionCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SupplierConditionCreate$lock()
