...
QuotaOverview <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new QuotaOverview class.
    #'
    ...
    initialize = function(`features`, `isTrialing`, `limits`, `metered`, `plan`, `planName`, `usage`, `trialEndsAt` = NULL, ...) {
      if (!missing(`features`)) {
      ...
      if (!missing(`metered`)) {
        ...
        sapply(`metered`, function(x) stopifnot(R6::is.R6(x)))
    ...
    #'
    #' @return QuotaOverview as a base R list.
    #' @examples
    #' # convert array of QuotaOverview (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert QuotaOverview to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      QuotaOverviewObject <- list()
      if (!is.null(self$`features`)) {
        QuotaOverviewObject[["features"]] <-
          self$extractSimpleType(self$`features`)
      }
      if (!is.null(self$`isTrialing`)) {
        QuotaOverviewObject[["isTrialing"]] <-
          self$`isTrialing`
      }
      if (!is.null(self$`limits`)) {
        QuotaOverviewObject[["limits"]] <-
          self$extractSimpleType(self$`limits`)
      }
      if (!is.null(self$`metered`)) {
        QuotaOverviewObject[["metered"]] <-
          self$extractSimpleType(self$`metered`)
      }
      if (!is.null(self$`plan`)) {
        QuotaOverviewObject[["plan"]] <-
          self$`plan`
      }
      if (!is.null(self$`planName`)) {
        QuotaOverviewObject[["planName"]] <-
          self$`planName`
      }
      if (!is.null(self$`trialEndsAt`)) {
        QuotaOverviewObject[["trialEndsAt"]] <-
          self$`trialEndsAt`
      }
      if (!is.null(self$`usage`)) {
        QuotaOverviewObject[["usage"]] <-
          self$extractSimpleType(self$`usage`)
      }
      return(QuotaOverviewObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of QuotaOverview
    #'
    #' @param input_json the JSON input
    #' @return the instance of QuotaOverview
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`metered`)) {
        self$`metered` <- ApiClient$new()$deserializeObj(this_object$`metered`, "array[MeteredUsage]", loadNamespace("openapi"))
      }
    ...
    #' @return QuotaOverview in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to QuotaOverview and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`features`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for QuotaOverview: the required field `features` is missing."))
      }
      ...
      if (!is.null(input_json$`isTrialing`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for QuotaOverview: the required field `isTrialing` is missing."))
      }
      # check the required field `limits`
      if (!is.null(input_json$`limits`)) {
        stopifnot(R6::is.R6(input_json$`limits`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for QuotaOverview: the required field `limits` is missing."))
      }
      # check the required field `metered`
      if (!is.null(input_json$`metered`)) {
        stopifnot(is.vector(input_json$`metered`), length(input_json$`metered`) != 0)
        tmp <- sapply(input_json$`metered`, function(x) stopifnot(R6::is.R6(x)))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for QuotaOverview: the required field `metered` is missing."))
      }
      ...
      if (!is.null(input_json$`plan`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for QuotaOverview: the required field `plan` is missing."))
      }
      ...
      if (!is.null(input_json$`planName`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for QuotaOverview: the required field `planName` is missing."))
      }
      # check the required field `usage`
      if (!is.null(input_json$`usage`)) {
        stopifnot(R6::is.R6(input_json$`usage`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for QuotaOverview: the required field `usage` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of QuotaOverview
    toString = function() {
      self$toJSONString()
    },
    ...
    isValid = function() {
      ...
      # check if the required `metered` is null
      if (is.null(self$`metered`)) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      # check if the required `metered` is null
      if (is.null(self$`metered`)) {
        invalid_fields["metered"] <- "Non-nullable required field `metered` cannot be null."
      }
...
# QuotaOverview$unlock()
#
## Below is an example to define the print function
# QuotaOverview$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
