...
#' @docType class
#' @title ProductCreate
#' @description ProductCreate Class
...
ProductCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProductCreate class.
    #'
    #' @param name name
    ...
    #'
    #' @return ProductCreate as a base R list.
    #' @examples
    #' # convert array of ProductCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProductCreateObject <- list()
      if (!is.null(self$`availability`)) {
        ProductCreateObject[["availability"]] <-
          self$`availability`
      }
      if (!is.null(self$`barcode`)) {
        ProductCreateObject[["barcode"]] <-
          self$`barcode`
      }
      if (!is.null(self$`brand`)) {
        ProductCreateObject[["brand"]] <-
          self$`brand`
      }
      if (!is.null(self$`categoryId`)) {
        ProductCreateObject[["categoryId"]] <-
          self$`categoryId`
      }
      if (!is.null(self$`condition`)) {
        ProductCreateObject[["condition"]] <-
          self$`condition`
      }
      if (!is.null(self$`defaultLedgerAccount`)) {
        ProductCreateObject[["defaultLedgerAccount"]] <-
          self$`defaultLedgerAccount`
      }
      if (!is.null(self$`defaultPrice`)) {
        ProductCreateObject[["defaultPrice"]] <-
          self$`defaultPrice`
      }
      if (!is.null(self$`defaultPriceFormulaId`)) {
        ProductCreateObject[["defaultPriceFormulaId"]] <-
          self$`defaultPriceFormulaId`
      }
      if (!is.null(self$`defaultTaxRate`)) {
        ProductCreateObject[["defaultTaxRate"]] <-
          self$`defaultTaxRate`
      }
      if (!is.null(self$`description`)) {
        ProductCreateObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`gtin`)) {
        ProductCreateObject[["gtin"]] <-
          self$`gtin`
      }
      if (!is.null(self$`height`)) {
        ProductCreateObject[["height"]] <-
          self$`height`
      }
      if (!is.null(self$`imageLink`)) {
        ProductCreateObject[["imageLink"]] <-
          self$`imageLink`
      }
      if (!is.null(self$`images`)) {
        ProductCreateObject[["images"]] <-
          self$extractSimpleType(self$`images`)
      }
      if (!is.null(self$`isTaxable`)) {
        ProductCreateObject[["isTaxable"]] <-
          self$`isTaxable`
      }
      if (!is.null(self$`length`)) {
        ProductCreateObject[["length"]] <-
          self$`length`
      }
      if (!is.null(self$`link`)) {
        ProductCreateObject[["link"]] <-
          self$`link`
      }
      if (!is.null(self$`maxStock`)) {
        ProductCreateObject[["maxStock"]] <-
          self$`maxStock`
      }
      if (!is.null(self$`minStock`)) {
        ProductCreateObject[["minStock"]] <-
          self$`minStock`
      }
      if (!is.null(self$`mpn`)) {
        ProductCreateObject[["mpn"]] <-
          self$`mpn`
      }
      if (!is.null(self$`name`)) {
        ProductCreateObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`packageHeight`)) {
        ProductCreateObject[["packageHeight"]] <-
          self$`packageHeight`
      }
      if (!is.null(self$`packageLength`)) {
        ProductCreateObject[["packageLength"]] <-
          self$`packageLength`
      }
      if (!is.null(self$`packageWeightUnit`)) {
        ProductCreateObject[["packageWeightUnit"]] <-
          self$`packageWeightUnit`
      }
      if (!is.null(self$`packageWeightValue`)) {
        ProductCreateObject[["packageWeightValue"]] <-
          self$`packageWeightValue`
      }
      if (!is.null(self$`packageWidth`)) {
        ProductCreateObject[["packageWidth"]] <-
          self$`packageWidth`
      }
      if (!is.null(self$`productCode`)) {
        ProductCreateObject[["productCode"]] <-
          self$`productCode`
      }
      if (!is.null(self$`productType`)) {
        ProductCreateObject[["productType"]] <-
          self$`productType`
      }
      if (!is.null(self$`purchasePrice`)) {
        ProductCreateObject[["purchasePrice"]] <-
          self$`purchasePrice`
      }
      if (!is.null(self$`reorderQuantity`)) {
        ProductCreateObject[["reorderQuantity"]] <-
          self$`reorderQuantity`
      }
      if (!is.null(self$`salePrice`)) {
        ProductCreateObject[["salePrice"]] <-
          self$`salePrice`
      }
      if (!is.null(self$`shippingPrice`)) {
        ProductCreateObject[["shippingPrice"]] <-
          self$`shippingPrice`
      }
      if (!is.null(self$`shippingRequiresInsurance`)) {
        ProductCreateObject[["shippingRequiresInsurance"]] <-
          self$`shippingRequiresInsurance`
      }
      if (!is.null(self$`sku`)) {
        ProductCreateObject[["sku"]] <-
          self$`sku`
      }
      if (!is.null(self$`stockQuantity`)) {
        ProductCreateObject[["stockQuantity"]] <-
          self$`stockQuantity`
      }
      if (!is.null(self$`tags`)) {
        ProductCreateObject[["tags"]] <-
          self$extractSimpleType(self$`tags`)
      }
      if (!is.null(self$`taxPrice`)) {
        ProductCreateObject[["taxPrice"]] <-
          self$`taxPrice`
      }
      if (!is.null(self$`trackBatch`)) {
        ProductCreateObject[["trackBatch"]] <-
          self$`trackBatch`
      }
      if (!is.null(self$`trackSerial`)) {
        ProductCreateObject[["trackSerial"]] <-
          self$`trackSerial`
      }
      if (!is.null(self$`unit`)) {
        ProductCreateObject[["unit"]] <-
          self$extractSimpleType(self$`unit`)
      }
      if (!is.null(self$`weightUnit`)) {
        ProductCreateObject[["weightUnit"]] <-
          self$`weightUnit`
      }
      if (!is.null(self$`weightValue`)) {
        ProductCreateObject[["weightValue"]] <-
          self$`weightValue`
      }
      if (!is.null(self$`width`)) {
        ProductCreateObject[["width"]] <-
          self$`width`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProductCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProductCreate
    ...
    #' @return ProductCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProductCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductCreate: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`productCode`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductCreate: the required field `productCode` is missing."))
      }
      ...
      if (!is.null(input_json$`sku`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductCreate: the required field `sku` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProductCreate
    toString = function() {
      self$toJSONString()
    },
...
# ProductCreate$unlock()
#
## Below is an example to define the print function
# ProductCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
