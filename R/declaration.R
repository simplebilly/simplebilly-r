...
Declaration <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Declaration class.
    #'
    ...
    #'
    #' @return Declaration as a base R list.
    #' @examples
    #' # convert array of Declaration (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert Declaration to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeclarationObject <- list()
      if (!is.null(self$`declarationType`)) {
        DeclarationObject[["declarationType"]] <-
          self$extractSimpleType(self$`declarationType`)
      }
      if (!is.null(self$`isCurrent`)) {
        DeclarationObject[["isCurrent"]] <-
          self$`isCurrent`
      }
      if (!is.null(self$`text`)) {
        DeclarationObject[["text"]] <-
          self$`text`
      }
      if (!is.null(self$`validFrom`)) {
        DeclarationObject[["validFrom"]] <-
          self$`validFrom`
      }
      if (!is.null(self$`version`)) {
        DeclarationObject[["version"]] <-
          self$`version`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of Declaration
    #'
    #' @param input_json the JSON input
    #' @return the instance of Declaration
    ...
    #' @return Declaration in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to Declaration and throw an exception if invalid
    #'
...
# Declaration$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
