...
#' @docType class
#' @title AbsenceCreate
#' @description AbsenceCreate Class
...
AbsenceCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AbsenceCreate class.
    #'
    ...
    #'
    #' @return AbsenceCreate as a base R list.
    #' @examples
    #' # convert array of AbsenceCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AbsenceCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AbsenceCreateObject <- list()
      if (!is.null(self$`absenceType`)) {
        AbsenceCreateObject[["absenceType"]] <-
          self$extractSimpleType(self$`absenceType`)
      }
      if (!is.null(self$`approvedAt`)) {
        AbsenceCreateObject[["approvedAt"]] <-
          self$`approvedAt`
      }
      if (!is.null(self$`approvedBy`)) {
        AbsenceCreateObject[["approvedBy"]] <-
          self$`approvedBy`
      }
      if (!is.null(self$`employeeId`)) {
        AbsenceCreateObject[["employeeId"]] <-
          self$`employeeId`
      }
      if (!is.null(self$`endDate`)) {
        AbsenceCreateObject[["endDate"]] <-
          self$`endDate`
      }
      if (!is.null(self$`notes`)) {
        AbsenceCreateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`startDate`)) {
        AbsenceCreateObject[["startDate"]] <-
          self$`startDate`
      }
      if (!is.null(self$`status`)) {
        AbsenceCreateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      return(AbsenceCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AbsenceCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of AbsenceCreate
    ...
    #' @return AbsenceCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AbsenceCreate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AbsenceCreate
    toString = function() {
      self$toJSONString()
    },
...
# AbsenceCreate$unlock()
#
## Below is an example to define the print function
# AbsenceCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
