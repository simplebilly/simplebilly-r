...
#' @description EmployeeCreate Class
...
EmployeeCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new EmployeeCreate class.
    #'
    ...
    #'
    #' @return EmployeeCreate as a base R list.
    #' @examples
    #' # convert array of EmployeeCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert EmployeeCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      EmployeeCreateObject <- list()
      if (!is.null(self$`address`)) {
        EmployeeCreateObject[["address"]] <-
          self$`address`
      }
      if (!is.null(self$`backupEmployeeId`)) {
        EmployeeCreateObject[["backupEmployeeId"]] <-
          self$`backupEmployeeId`
      }
      if (!is.null(self$`bic`)) {
        EmployeeCreateObject[["bic"]] <-
          self$`bic`
      }
      if (!is.null(self$`city`)) {
        EmployeeCreateObject[["city"]] <-
          self$`city`
      }
      if (!is.null(self$`country`)) {
        EmployeeCreateObject[["country"]] <-
          self$extractSimpleType(self$`country`)
      }
      if (!is.null(self$`dateOfBirth`)) {
        EmployeeCreateObject[["dateOfBirth"]] <-
          self$`dateOfBirth`
      }
      if (!is.null(self$`departmentId`)) {
        EmployeeCreateObject[["departmentId"]] <-
          self$`departmentId`
      }
      if (!is.null(self$`email`)) {
        EmployeeCreateObject[["email"]] <-
          self$`email`
      }
      if (!is.null(self$`firstName`)) {
        EmployeeCreateObject[["firstName"]] <-
          self$`firstName`
      }
      if (!is.null(self$`gender`)) {
        EmployeeCreateObject[["gender"]] <-
          self$extractSimpleType(self$`gender`)
      }
      if (!is.null(self$`hireDate`)) {
        EmployeeCreateObject[["hireDate"]] <-
          self$`hireDate`
      }
      if (!is.null(self$`hourlyCost`)) {
        EmployeeCreateObject[["hourlyCost"]] <-
          self$`hourlyCost`
      }
      if (!is.null(self$`iban`)) {
        EmployeeCreateObject[["iban"]] <-
          self$`iban`
      }
      if (!is.null(self$`jobTitle`)) {
        EmployeeCreateObject[["jobTitle"]] <-
          self$`jobTitle`
      }
      if (!is.null(self$`lastLogin`)) {
        EmployeeCreateObject[["lastLogin"]] <-
          self$`lastLogin`
      }
      if (!is.null(self$`lastName`)) {
        EmployeeCreateObject[["lastName"]] <-
          self$`lastName`
      }
      if (!is.null(self$`lastUpdated`)) {
        EmployeeCreateObject[["lastUpdated"]] <-
          self$`lastUpdated`
      }
      if (!is.null(self$`monthlySalary`)) {
        EmployeeCreateObject[["monthlySalary"]] <-
          self$`monthlySalary`
      }
      if (!is.null(self$`phone`)) {
        EmployeeCreateObject[["phone"]] <-
          self$`phone`
      }
      if (!is.null(self$`state`)) {
        EmployeeCreateObject[["state"]] <-
          self$`state`
      }
      if (!is.null(self$`status`)) {
        EmployeeCreateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`userId`)) {
        EmployeeCreateObject[["userId"]] <-
          self$`userId`
      }
      if (!is.null(self$`weeklyHours`)) {
        EmployeeCreateObject[["weeklyHours"]] <-
          self$`weeklyHours`
      }
      if (!is.null(self$`zip`)) {
        EmployeeCreateObject[["zip"]] <-
          self$`zip`
      }
      return(EmployeeCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of EmployeeCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of EmployeeCreate
    ...
    #' @return EmployeeCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to EmployeeCreate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of EmployeeCreate
    toString = function() {
      self$toJSONString()
    },
...
# EmployeeCreate$unlock()
#
## Below is an example to define the print function
# EmployeeCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
