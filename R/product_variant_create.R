#' Create a new ProductVariantCreate
#'
#' @description
#' ProductVariantCreate Class
#'
#' @docType class
#' @title ProductVariantCreate
#' @description ProductVariantCreate Class
...
#' @export
ProductVariantCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProductVariantCreate class.
    #'
    ...
    #'
    #' @return ProductVariantCreate as a base R list.
    #' @examples
    #' # convert array of ProductVariantCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductVariantCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProductVariantCreateObject <- list()
      if (!is.null(self$`barcode`)) {
        ProductVariantCreateObject[["barcode"]] <-
          self$`barcode`
      }
      if (!is.null(self$`imageLink`)) {
        ProductVariantCreateObject[["imageLink"]] <-
          self$`imageLink`
      }
      if (!is.null(self$`isActive`)) {
        ProductVariantCreateObject[["isActive"]] <-
          self$`isActive`
      }
      if (!is.null(self$`name`)) {
        ProductVariantCreateObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`optionValues`)) {
        ProductVariantCreateObject[["optionValues"]] <-
          self$extractSimpleType(self$`optionValues`)
      }
      if (!is.null(self$`price`)) {
        ProductVariantCreateObject[["price"]] <-
          self$`price`
      }
      if (!is.null(self$`priceDelta`)) {
        ProductVariantCreateObject[["priceDelta"]] <-
          self$`priceDelta`
      }
      if (!is.null(self$`productId`)) {
        ProductVariantCreateObject[["productId"]] <-
          self$`productId`
      }
      if (!is.null(self$`sku`)) {
        ProductVariantCreateObject[["sku"]] <-
          self$`sku`
      }
      if (!is.null(self$`stockQuantity`)) {
        ProductVariantCreateObject[["stockQuantity"]] <-
          self$`stockQuantity`
      }
      return(ProductVariantCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProductVariantCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProductVariantCreate
    ...
    #' @return ProductVariantCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProductVariantCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`productId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductVariantCreate: the required field `productId` is missing."))
      }
      ...
      if (!is.null(input_json$`sku`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProductVariantCreate: the required field `sku` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProductVariantCreate
    toString = function() {
      self$toJSONString()
    },
...
# ProductVariantCreate$unlock()
#
## Below is an example to define the print function
# ProductVariantCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProductVariantCreate$lock()
