#' Create a new ParticipationUpdate
#'
#' @description
#' ParticipationUpdate Class
#'
#' @docType class
#' @title ParticipationUpdate
#' @description ParticipationUpdate Class
...
#' @export
ParticipationUpdate <- R6::R6Class(
  "ParticipationUpdate",
  public = list(
    `acquiredAt` = NULL,
    ...
    #' @description
    #' Initialize a new ParticipationUpdate class.
    #'
    ...
    #'
    #' @return ParticipationUpdate as a base R list.
    #' @examples
    #' # convert array of ParticipationUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ParticipationUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ParticipationUpdateObject <- list()
      if (!is.null(self$`acquiredAt`)) {
        ParticipationUpdateObject[["acquiredAt"]] <-
          self$`acquiredAt`
      }
      if (!is.null(self$`boardAppointment`)) {
        ParticipationUpdateObject[["boardAppointment"]] <-
          self$`boardAppointment`
      }
      if (!is.null(self$`companyName`)) {
        ParticipationUpdateObject[["companyName"]] <-
          self$`companyName`
      }
      if (!is.null(self$`controlAgreement`)) {
        ParticipationUpdateObject[["controlAgreement"]] <-
          self$`controlAgreement`
      }
      if (!is.null(self$`legalForm`)) {
        ParticipationUpdateObject[["legalForm"]] <-
          self$`legalForm`
      }
      if (!is.null(self$`ownershipPct`)) {
        ParticipationUpdateObject[["ownershipPct"]] <-
          self$`ownershipPct`
      }
      if (!is.null(self$`purposeVehicle`)) {
        ParticipationUpdateObject[["purposeVehicle"]] <-
          self$`purposeVehicle`
      }
      if (!is.null(self$`votingMajority`)) {
        ParticipationUpdateObject[["votingMajority"]] <-
          self$`votingMajority`
      }
      return(ParticipationUpdateObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ParticipationUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ParticipationUpdate
    ...
    #' @return ParticipationUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ParticipationUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ParticipationUpdate
    toString = function() {
      self$toJSONString()
    },
...
# ParticipationUpdate$unlock()
#
## Below is an example to define the print function
# ParticipationUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ParticipationUpdate$lock()
