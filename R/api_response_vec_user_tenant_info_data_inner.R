#' Create a new ApiResponseVecUserTenantInfoDataInner
#'
#' @description
#' ApiResponseVecUserTenantInfoDataInner Class
#'
#' @docType class
#' @title ApiResponseVecUserTenantInfoDataInner
#' @description ApiResponseVecUserTenantInfoDataInner Class
...
#' @export
ApiResponseVecUserTenantInfoDataInner <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ApiResponseVecUserTenantInfoDataInner class.
    #'
    #' @param role role
    ...
    #'
    #' @return ApiResponseVecUserTenantInfoDataInner as a base R list.
    #' @examples
    #' # convert array of ApiResponseVecUserTenantInfoDataInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ApiResponseVecUserTenantInfoDataInner to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ApiResponseVecUserTenantInfoDataInnerObject <- list()
      if (!is.null(self$`custom_domain`)) {
        ApiResponseVecUserTenantInfoDataInnerObject[["custom_domain"]] <-
          self$`custom_domain`
      }
      if (!is.null(self$`role`)) {
        ApiResponseVecUserTenantInfoDataInnerObject[["role"]] <-
          self$`role`
      }
      if (!is.null(self$`subdomain`)) {
        ApiResponseVecUserTenantInfoDataInnerObject[["subdomain"]] <-
          self$`subdomain`
      }
      if (!is.null(self$`tenant_id`)) {
        ApiResponseVecUserTenantInfoDataInnerObject[["tenant_id"]] <-
          self$`tenant_id`
      }
      if (!is.null(self$`tenant_name`)) {
        ApiResponseVecUserTenantInfoDataInnerObject[["tenant_name"]] <-
          self$`tenant_name`
      }
      return(ApiResponseVecUserTenantInfoDataInnerObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ApiResponseVecUserTenantInfoDataInner
    #'
    #' @param input_json the JSON input
    #' @return the instance of ApiResponseVecUserTenantInfoDataInner
    ...
    #' @return ApiResponseVecUserTenantInfoDataInner in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ApiResponseVecUserTenantInfoDataInner and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`role`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseVecUserTenantInfoDataInner: the required field `role` is missing."))
      }
      ...
      if (!is.null(input_json$`tenant_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseVecUserTenantInfoDataInner: the required field `tenant_id` is missing."))
      }
      ...
      if (!is.null(input_json$`tenant_name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseVecUserTenantInfoDataInner: the required field `tenant_name` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ApiResponseVecUserTenantInfoDataInner
    toString = function() {
      self$toJSONString()
    },
...
# ApiResponseVecUserTenantInfoDataInner$unlock()
#
## Below is an example to define the print function
# ApiResponseVecUserTenantInfoDataInner$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ApiResponseVecUserTenantInfoDataInner$lock()
