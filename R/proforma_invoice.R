...
#' @description ProformaInvoice Class
...
ProformaInvoice <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProformaInvoice class.
    #'
    ...
    #'
    #' @return ProformaInvoice as a base R list.
    #' @examples
    #' # convert array of ProformaInvoice (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProformaInvoice to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProformaInvoiceObject <- list()
      if (!is.null(self$`convertedAt`)) {
        ProformaInvoiceObject[["convertedAt"]] <-
          self$`convertedAt`
      }
      if (!is.null(self$`convertedToInvoiceId`)) {
        ProformaInvoiceObject[["convertedToInvoiceId"]] <-
          self$`convertedToInvoiceId`
      }
      if (!is.null(self$`currency`)) {
        ProformaInvoiceObject[["currency"]] <-
          self$extractSimpleType(self$`currency`)
      }
      if (!is.null(self$`customerId`)) {
        ProformaInvoiceObject[["customerId"]] <-
          self$`customerId`
      }
      if (!is.null(self$`customerSnapshot`)) {
        ProformaInvoiceObject[["customerSnapshot"]] <-
          self$extractSimpleType(self$`customerSnapshot`)
      }
      if (!is.null(self$`issueDate`)) {
        ProformaInvoiceObject[["issueDate"]] <-
          self$`issueDate`
      }
      if (!is.null(self$`lineItems`)) {
        ProformaInvoiceObject[["lineItems"]] <-
          self$extractSimpleType(self$`lineItems`)
      }
      if (!is.null(self$`notes`)) {
        ProformaInvoiceObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`orderNumber`)) {
        ProformaInvoiceObject[["orderNumber"]] <-
          self$`orderNumber`
      }
      if (!is.null(self$`paymentDueDate`)) {
        ProformaInvoiceObject[["paymentDueDate"]] <-
          self$`paymentDueDate`
      }
      if (!is.null(self$`quotationId`)) {
        ProformaInvoiceObject[["quotationId"]] <-
          self$`quotationId`
      }
      if (!is.null(self$`status`)) {
        ProformaInvoiceObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`subtotal`)) {
        ProformaInvoiceObject[["subtotal"]] <-
          self$`subtotal`
      }
      if (!is.null(self$`totalAmount`)) {
        ProformaInvoiceObject[["totalAmount"]] <-
          self$`totalAmount`
      }
      if (!is.null(self$`totalTax`)) {
        ProformaInvoiceObject[["totalTax"]] <-
          self$`totalTax`
      }
      return(ProformaInvoiceObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProformaInvoice
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProformaInvoice
    ...
    #' @return ProformaInvoice in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProformaInvoice and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`currency`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProformaInvoice: the required field `currency` is missing."))
      }
      ...
      if (!is.null(input_json$`issueDate`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProformaInvoice: the required field `issueDate` is missing."))
      }
      # check the required field `lineItems`
      if (!is.null(input_json$`lineItems`)) {
        stopifnot(R6::is.R6(input_json$`lineItems`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ProformaInvoice: the required field `lineItems` is missing."))
      }
      # check the required field `status`
      if (!is.null(input_json$`status`)) {
        stopifnot(R6::is.R6(input_json$`status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ProformaInvoice: the required field `status` is missing."))
      }
      ...
      if (!is.null(input_json$`subtotal`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProformaInvoice: the required field `subtotal` is missing."))
      }
      ...
      if (!is.null(input_json$`totalAmount`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProformaInvoice: the required field `totalAmount` is missing."))
      }
      ...
      if (!is.null(input_json$`totalTax`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProformaInvoice: the required field `totalTax` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProformaInvoice
    toString = function() {
      self$toJSONString()
    },
...
# ProformaInvoice$unlock()
#
## Below is an example to define the print function
# ProformaInvoice$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProformaInvoice$lock()
