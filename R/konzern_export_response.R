#' Create a new KonzernExportResponse
#'
#' @description
#' KonzernExportResponse Class
#'
#' @docType class
#' @title KonzernExportResponse
#' @description KonzernExportResponse Class
...
#' @export
KonzernExportResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new KonzernExportResponse class.
    #'
    ...
    #'
    #' @return KonzernExportResponse as a base R list.
    #' @examples
    #' # convert array of KonzernExportResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert KonzernExportResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      KonzernExportResponseObject <- list()
      if (!is.null(self$`csv_content`)) {
        KonzernExportResponseObject[["csv_content"]] <-
          self$`csv_content`
      }
      if (!is.null(self$`filename`)) {
        KonzernExportResponseObject[["filename"]] <-
          self$`filename`
      }
      return(KonzernExportResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of KonzernExportResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of KonzernExportResponse
    ...
    #' @return KonzernExportResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to KonzernExportResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`csv_content`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for KonzernExportResponse: the required field `csv_content` is missing."))
      }
      ...
      if (!is.null(input_json$`filename`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for KonzernExportResponse: the required field `filename` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of KonzernExportResponse
    toString = function() {
      self$toJSONString()
    },
...
# KonzernExportResponse$unlock()
#
## Below is an example to define the print function
# KonzernExportResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# KonzernExportResponse$lock()
