#' Create a new OAuthAuthorizeResponse
#'
#' @description
...
#' @description OAuthAuthorizeResponse Class
...
#' @export
OAuthAuthorizeResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OAuthAuthorizeResponse class.
    #'
    ...
    #'
    #' @return OAuthAuthorizeResponse as a base R list.
    #' @examples
    #' # convert array of OAuthAuthorizeResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OAuthAuthorizeResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OAuthAuthorizeResponseObject <- list()
      if (!is.null(self$`authorization_url`)) {
        OAuthAuthorizeResponseObject[["authorization_url"]] <-
          self$`authorization_url`
      }
      if (!is.null(self$`state`)) {
        OAuthAuthorizeResponseObject[["state"]] <-
          self$`state`
      }
      return(OAuthAuthorizeResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of OAuthAuthorizeResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of OAuthAuthorizeResponse
    ...
    #' @return OAuthAuthorizeResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OAuthAuthorizeResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`authorization_url`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OAuthAuthorizeResponse: the required field `authorization_url` is missing."))
      }
      ...
      if (!is.null(input_json$`state`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OAuthAuthorizeResponse: the required field `state` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of OAuthAuthorizeResponse
    toString = function() {
      self$toJSONString()
    },
...
# OAuthAuthorizeResponse$unlock()
#
## Below is an example to define the print function
# OAuthAuthorizeResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OAuthAuthorizeResponse$lock()
