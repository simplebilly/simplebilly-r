...
Quotation <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Quotation class.
    #'
    ...
    initialize = function(`currency`, `voucherDate`, `voucherStatus`, `address` = NULL, `contactId` = NULL, `contactName` = NULL, `expirationDate` = NULL, `files` = NULL, `introduction` = NULL, `lineItems` = NULL, `precedingSalesVoucherId` = NULL, `precedingSalesVoucherType` = NULL, `quotationNumber` = NULL, `remark` = NULL, `subtotal` = NULL, `taxCondition` = NULL, `title` = NULL, `totalAmount` = NULL, `totalTax` = NULL, ...) {
      if (!missing(`currency`)) {
    ...
    #'
    #' @return Quotation as a base R list.
    #' @examples
    #' # convert array of Quotation (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`remark`)) {
        QuotationObject[["remark"]] <-
          self$`remark`
      }
      if (!is.null(self$`subtotal`)) {
        QuotationObject[["subtotal"]] <-
          self$`subtotal`
      }
      if (!is.null(self$`taxCondition`)) {
        QuotationObject[["taxCondition"]] <-
          self$`taxCondition`
      }
      if (!is.null(self$`title`)) {
        QuotationObject[["title"]] <-
          self$`title`
      }
      if (!is.null(self$`totalAmount`)) {
        QuotationObject[["totalAmount"]] <-
          self$`totalAmount`
      }
      if (!is.null(self$`totalTax`)) {
        QuotationObject[["totalTax"]] <-
          self$`totalTax`
      }
      if (!is.null(self$`voucherDate`)) {
        QuotationObject[["voucherDate"]] <-
          self$`voucherDate`
      }
      if (!is.null(self$`voucherStatus`)) {
        QuotationObject[["voucherStatus"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of Quotation
    #'
    #' @param input_json the JSON input
    #' @return the instance of Quotation
    ...
    #' @return Quotation in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to Quotation and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`currency`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Quotation: the required field `currency` is missing."))
      }
      ...
      if (!is.null(input_json$`voucherDate`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Quotation: the required field `voucherDate` is missing."))
      }
      # check the required field `voucherStatus`
      if (!is.null(input_json$`voucherStatus`)) {
        stopifnot(R6::is.R6(input_json$`voucherStatus`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for Quotation: the required field `voucherStatus` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of Quotation
    toString = function() {
      self$toJSONString()
    },
...
# Quotation$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
