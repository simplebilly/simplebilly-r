#' Create a new SupplierInvoiceCreate
#'
#' @description
#' SupplierInvoiceCreate Class
#'
#' @docType class
#' @title SupplierInvoiceCreate
#' @description SupplierInvoiceCreate Class
...
#' @export
SupplierInvoiceCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new SupplierInvoiceCreate class.
    #'
    ...
    #'
    #' @return SupplierInvoiceCreate as a base R list.
    #' @examples
    #' # convert array of SupplierInvoiceCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SupplierInvoiceCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SupplierInvoiceCreateObject <- list()
      if (!is.null(self$`currency`)) {
        SupplierInvoiceCreateObject[["currency"]] <-
          self$`currency`
      }
      if (!is.null(self$`goodsReceiptId`)) {
        SupplierInvoiceCreateObject[["goodsReceiptId"]] <-
          self$`goodsReceiptId`
      }
      if (!is.null(self$`invoiceDate`)) {
        SupplierInvoiceCreateObject[["invoiceDate"]] <-
          self$`invoiceDate`
      }
      if (!is.null(self$`invoiceNumber`)) {
        SupplierInvoiceCreateObject[["invoiceNumber"]] <-
          self$`invoiceNumber`
      }
      if (!is.null(self$`lineItems`)) {
        SupplierInvoiceCreateObject[["lineItems"]] <-
          self$extractSimpleType(self$`lineItems`)
      }
      if (!is.null(self$`notes`)) {
        SupplierInvoiceCreateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`purchaseOrderId`)) {
        SupplierInvoiceCreateObject[["purchaseOrderId"]] <-
          self$`purchaseOrderId`
      }
      if (!is.null(self$`status`)) {
        SupplierInvoiceCreateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`supplierContactId`)) {
        SupplierInvoiceCreateObject[["supplierContactId"]] <-
          self$`supplierContactId`
      }
      if (!is.null(self$`supplierName`)) {
        SupplierInvoiceCreateObject[["supplierName"]] <-
          self$`supplierName`
      }
      if (!is.null(self$`totalGrossAmount`)) {
        SupplierInvoiceCreateObject[["totalGrossAmount"]] <-
          self$`totalGrossAmount`
      }
      if (!is.null(self$`totalNetAmount`)) {
        SupplierInvoiceCreateObject[["totalNetAmount"]] <-
          self$`totalNetAmount`
      }
      return(SupplierInvoiceCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of SupplierInvoiceCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of SupplierInvoiceCreate
    ...
    #' @return SupplierInvoiceCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SupplierInvoiceCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`invoiceDate`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SupplierInvoiceCreate: the required field `invoiceDate` is missing."))
      }
      ...
      if (!is.null(input_json$`invoiceNumber`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SupplierInvoiceCreate: the required field `invoiceNumber` is missing."))
      }
      # check the required field `lineItems`
      if (!is.null(input_json$`lineItems`)) {
        stopifnot(R6::is.R6(input_json$`lineItems`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for SupplierInvoiceCreate: the required field `lineItems` is missing."))
      }
      # check the required field `status`
      if (!is.null(input_json$`status`)) {
        stopifnot(R6::is.R6(input_json$`status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for SupplierInvoiceCreate: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of SupplierInvoiceCreate
    toString = function() {
      self$toJSONString()
    },
...
# SupplierInvoiceCreate$unlock()
#
## Below is an example to define the print function
# SupplierInvoiceCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SupplierInvoiceCreate$lock()
