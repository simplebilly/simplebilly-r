...
ShopApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AnyType
    ShopEditorSave = function(body, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$ShopEditorSaveWithHttpInfo(body, data_file = data_file, ..., .parse = .parse)
    ...
    ShopEditorSaveWithHttpInfo = function(body, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/api/v1/shop/editor"
      # Bearer token
