...
#' @docType class
#' @title Participation
#' @description Participation Class
...
Participation <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Participation class.
    #'
    ...
    #'
    #' @return Participation as a base R list.
    #' @examples
    #' # convert array of Participation (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert Participation to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ParticipationObject <- list()
      if (!is.null(self$`acquiredAt`)) {
        ParticipationObject[["acquiredAt"]] <-
          self$`acquiredAt`
      }
      if (!is.null(self$`boardAppointment`)) {
        ParticipationObject[["boardAppointment"]] <-
          self$`boardAppointment`
      }
      if (!is.null(self$`companyName`)) {
        ParticipationObject[["companyName"]] <-
          self$`companyName`
      }
      if (!is.null(self$`controlAgreement`)) {
        ParticipationObject[["controlAgreement"]] <-
          self$`controlAgreement`
      }
      if (!is.null(self$`legalForm`)) {
        ParticipationObject[["legalForm"]] <-
          self$`legalForm`
      }
      if (!is.null(self$`ownershipPct`)) {
        ParticipationObject[["ownershipPct"]] <-
          self$`ownershipPct`
      }
      if (!is.null(self$`purposeVehicle`)) {
        ParticipationObject[["purposeVehicle"]] <-
          self$`purposeVehicle`
      }
      if (!is.null(self$`votingMajority`)) {
        ParticipationObject[["votingMajority"]] <-
          self$`votingMajority`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of Participation
    #'
    #' @param input_json the JSON input
    #' @return the instance of Participation
    ...
    #' @return Participation in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to Participation and throw an exception if invalid
    #'
...
# Participation$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
