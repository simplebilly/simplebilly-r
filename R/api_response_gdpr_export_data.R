#' Create a new ApiResponseGdprExportData
#'
#' @description
#' ApiResponseGdprExportData Class
#'
#' @docType class
#' @title ApiResponseGdprExportData
#' @description ApiResponseGdprExportData Class
...
#' @export
ApiResponseGdprExportData <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ApiResponseGdprExportData class.
    #'
    ...
    #'
    #' @return ApiResponseGdprExportData as a base R list.
    #' @examples
    #' # convert array of ApiResponseGdprExportData (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of ApiResponseGdprExportData
    #'
    #' @param input_json the JSON input
    #' @return the instance of ApiResponseGdprExportData
    ...
    #' @return ApiResponseGdprExportData in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ApiResponseGdprExportData and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`activityLog`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `activityLog` is missing."))
      }
      ...
      if (!is.null(input_json$`apiKeys`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `apiKeys` is missing."))
      }
      ...
      if (!is.null(input_json$`billing`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `billing` is missing."))
      }
      ...
      if (!is.null(input_json$`exportedAt`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `exportedAt` is missing."))
      }
      ...
      if (!is.null(input_json$`generatedByAi`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `generatedByAi` is missing."))
      }
      ...
      if (!is.null(input_json$`notifications`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `notifications` is missing."))
      }
      ...
      if (!is.null(input_json$`refreshTokens`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `refreshTokens` is missing."))
      }
      ...
      if (!is.null(input_json$`tenants`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `tenants` is missing."))
      }
      ...
      if (!is.null(input_json$`usageEvents`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `usageEvents` is missing."))
      }
      # check the required field `user`
      if (!is.null(input_json$`user`)) {
        stopifnot(R6::is.R6(input_json$`user`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ApiResponseGdprExportData: the required field `user` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ApiResponseGdprExportData
    toString = function() {
      self$toJSONString()
    },
...
# ApiResponseGdprExportData$unlock()
#
## Below is an example to define the print function
# ApiResponseGdprExportData$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ApiResponseGdprExportData$lock()
