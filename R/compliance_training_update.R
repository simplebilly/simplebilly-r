#' Create a new ComplianceTrainingUpdate
#'
#' @description
#' ComplianceTrainingUpdate Class
#'
#' @docType class
#' @title ComplianceTrainingUpdate
#' @description ComplianceTrainingUpdate Class
...
#' @export
ComplianceTrainingUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ComplianceTrainingUpdate class.
    #'
    ...
    #'
    #' @return ComplianceTrainingUpdate as a base R list.
    #' @examples
    #' # convert array of ComplianceTrainingUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ComplianceTrainingUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ComplianceTrainingUpdateObject <- list()
      if (!is.null(self$`assignable`)) {
        ComplianceTrainingUpdateObject[["assignable"]] <-
          self$`assignable`
      }
      if (!is.null(self$`code`)) {
        ComplianceTrainingUpdateObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`description`)) {
        ComplianceTrainingUpdateObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`passScore`)) {
        ComplianceTrainingUpdateObject[["passScore"]] <-
          self$`passScore`
      }
      if (!is.null(self$`pluginPlatform`)) {
        ComplianceTrainingUpdateObject[["pluginPlatform"]] <-
          self$`pluginPlatform`
      }
      if (!is.null(self$`source`)) {
        ComplianceTrainingUpdateObject[["source"]] <-
          self$extractSimpleType(self$`source`)
      }
      if (!is.null(self$`title`)) {
        ComplianceTrainingUpdateObject[["title"]] <-
          self$`title`
      }
      if (!is.null(self$`validityMonths`)) {
        ComplianceTrainingUpdateObject[["validityMonths"]] <-
          self$`validityMonths`
      }
      return(ComplianceTrainingUpdateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ComplianceTrainingUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ComplianceTrainingUpdate
    ...
    #' @return ComplianceTrainingUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ComplianceTrainingUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ComplianceTrainingUpdate
    toString = function() {
      self$toJSONString()
    },
...
# ComplianceTrainingUpdate$unlock()
#
## Below is an example to define the print function
# ComplianceTrainingUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ComplianceTrainingUpdate$lock()
