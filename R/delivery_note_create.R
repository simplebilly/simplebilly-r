#' Create a new DeliveryNoteCreate
#'
#' @description
#' DeliveryNoteCreate Class
#'
#' @docType class
#' @title DeliveryNoteCreate
#' @description DeliveryNoteCreate Class
...
DeliveryNoteCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DeliveryNoteCreate class.
    #'
    ...
    #'
    #' @return DeliveryNoteCreate as a base R list.
    #' @examples
    #' # convert array of DeliveryNoteCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeliveryNoteCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeliveryNoteCreateObject <- list()
      if (!is.null(self$`address`)) {
        DeliveryNoteCreateObject[["address"]] <-
          self$extractSimpleType(self$`address`)
      }
      if (!is.null(self$`contactId`)) {
        DeliveryNoteCreateObject[["contactId"]] <-
          self$`contactId`
      }
      if (!is.null(self$`contactName`)) {
        DeliveryNoteCreateObject[["contactName"]] <-
          self$`contactName`
      }
      if (!is.null(self$`currency`)) {
        DeliveryNoteCreateObject[["currency"]] <-
          self$`currency`
      }
      if (!is.null(self$`deliveryDate`)) {
        DeliveryNoteCreateObject[["deliveryDate"]] <-
          self$`deliveryDate`
      }
      if (!is.null(self$`deliveryNoteNumber`)) {
        DeliveryNoteCreateObject[["deliveryNoteNumber"]] <-
          self$`deliveryNoteNumber`
      }
      if (!is.null(self$`files`)) {
        DeliveryNoteCreateObject[["files"]] <-
          self$extractSimpleType(self$`files`)
      }
      if (!is.null(self$`introduction`)) {
        DeliveryNoteCreateObject[["introduction"]] <-
          self$`introduction`
      }
      if (!is.null(self$`lineItems`)) {
        DeliveryNoteCreateObject[["lineItems"]] <-
          self$extractSimpleType(self$`lineItems`)
      }
      if (!is.null(self$`precedingSalesVoucherId`)) {
        DeliveryNoteCreateObject[["precedingSalesVoucherId"]] <-
          self$`precedingSalesVoucherId`
      }
      if (!is.null(self$`precedingSalesVoucherType`)) {
        DeliveryNoteCreateObject[["precedingSalesVoucherType"]] <-
          self$extractSimpleType(self$`precedingSalesVoucherType`)
      }
      if (!is.null(self$`remark`)) {
        DeliveryNoteCreateObject[["remark"]] <-
          self$`remark`
      }
      if (!is.null(self$`shippingDate`)) {
        DeliveryNoteCreateObject[["shippingDate"]] <-
          self$`shippingDate`
      }
      if (!is.null(self$`shippingMethod`)) {
        DeliveryNoteCreateObject[["shippingMethod"]] <-
          self$`shippingMethod`
      }
      if (!is.null(self$`title`)) {
        DeliveryNoteCreateObject[["title"]] <-
          self$`title`
      }
      if (!is.null(self$`voucherDate`)) {
        DeliveryNoteCreateObject[["voucherDate"]] <-
          self$`voucherDate`
      }
      if (!is.null(self$`voucherStatus`)) {
        DeliveryNoteCreateObject[["voucherStatus"]] <-
          self$extractSimpleType(self$`voucherStatus`)
      }
      return(DeliveryNoteCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of DeliveryNoteCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeliveryNoteCreate
    ...
    #' @return DeliveryNoteCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DeliveryNoteCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`currency`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryNoteCreate: the required field `currency` is missing."))
      }
      ...
      if (!is.null(input_json$`voucherDate`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryNoteCreate: the required field `voucherDate` is missing."))
      }
      # check the required field `voucherStatus`
      if (!is.null(input_json$`voucherStatus`)) {
        stopifnot(R6::is.R6(input_json$`voucherStatus`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for DeliveryNoteCreate: the required field `voucherStatus` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DeliveryNoteCreate
    toString = function() {
      self$toJSONString()
    },
...
# DeliveryNoteCreate$unlock()
#
## Below is an example to define the print function
# DeliveryNoteCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DeliveryNoteCreate$lock()
