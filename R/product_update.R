...
#' @field productCode  character [optional]
...
ProductUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`availability` = NULL, `barcode` = NULL, `brand` = NULL, `categoryId` = NULL, `condition` = NULL, `defaultLedgerAccount` = NULL, `defaultPrice` = NULL, `defaultPriceFormulaId` = NULL, `defaultTaxRate` = NULL, `description` = NULL, `gtin` = NULL, `height` = NULL, `imageLink` = NULL, `images` = NULL, `isTaxable` = NULL, `length` = NULL, `link` = NULL, `maxStock` = NULL, `minStock` = NULL, `mpn` = NULL, `name` = NULL, `packageHeight` = NULL, `packageLength` = NULL, `packageWeightUnit` = NULL, `packageWeightValue` = NULL, `packageWidth` = NULL, `productCode` = NULL, `productType` = NULL, `purchasePrice` = NULL, `reorderQuantity` = NULL, `salePrice` = NULL, `shippingPrice` = NULL, `shippingRequiresInsurance` = NULL, `sku` = NULL, `stockQuantity` = NULL, `tags` = NULL, `taxPrice` = NULL, `trackBatch` = NULL, `trackSerial` = NULL, `unit` = NULL, `weightUnit` = NULL, `weightValue` = NULL, `width` = NULL, ...) {
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`availability`)) {
        ProductUpdateObject[["availability"]] <-
          self$`availability`
      }
      ...
      if (!is.null(self$`brand`)) {
        ProductUpdateObject[["brand"]] <-
          self$`brand`
      }
      if (!is.null(self$`categoryId`)) {
        ProductUpdateObject[["categoryId"]] <-
          self$`categoryId`
      }
      ...
      if (!is.null(self$`defaultLedgerAccount`)) {
        ProductUpdateObject[["defaultLedgerAccount"]] <-
          self$`defaultLedgerAccount`
      }
      if (!is.null(self$`defaultPrice`)) {
        ProductUpdateObject[["defaultPrice"]] <-
          self$`defaultPrice`
      }
      if (!is.null(self$`defaultPriceFormulaId`)) {
        ProductUpdateObject[["defaultPriceFormulaId"]] <-
          self$`defaultPriceFormulaId`
      }
      if (!is.null(self$`defaultTaxRate`)) {
        ProductUpdateObject[["defaultTaxRate"]] <-
          self$`defaultTaxRate`
      }
      ...
      if (!is.null(self$`imageLink`)) {
        ProductUpdateObject[["imageLink"]] <-
          self$`imageLink`
      }
      if (!is.null(self$`images`)) {
        ProductUpdateObject[["images"]] <-
          self$extractSimpleType(self$`images`)
      }
      if (!is.null(self$`isTaxable`)) {
        ProductUpdateObject[["isTaxable"]] <-
          self$`isTaxable`
      }
      ...
      if (!is.null(self$`link`)) {
        ProductUpdateObject[["link"]] <-
          self$`link`
      }
      if (!is.null(self$`maxStock`)) {
        ProductUpdateObject[["maxStock"]] <-
          self$`maxStock`
      }
      if (!is.null(self$`minStock`)) {
        ProductUpdateObject[["minStock"]] <-
          self$`minStock`
      }
      if (!is.null(self$`mpn`)) {
      ...
      if (!is.null(self$`packageHeight`)) {
        ProductUpdateObject[["packageHeight"]] <-
          self$`packageHeight`
      }
      if (!is.null(self$`packageLength`)) {
        ProductUpdateObject[["packageLength"]] <-
          self$`packageLength`
      }
      if (!is.null(self$`packageWeightUnit`)) {
        ProductUpdateObject[["packageWeightUnit"]] <-
          self$`packageWeightUnit`
      }
      if (!is.null(self$`packageWeightValue`)) {
        ProductUpdateObject[["packageWeightValue"]] <-
          self$`packageWeightValue`
      }
      if (!is.null(self$`packageWidth`)) {
        ProductUpdateObject[["packageWidth"]] <-
          self$`packageWidth`
      }
      if (!is.null(self$`productCode`)) {
        ProductUpdateObject[["productCode"]] <-
          self$`productCode`
      }
      if (!is.null(self$`productType`)) {
        ProductUpdateObject[["productType"]] <-
          self$`productType`
      }
      if (!is.null(self$`purchasePrice`)) {
        ProductUpdateObject[["purchasePrice"]] <-
          self$`purchasePrice`
      }
      if (!is.null(self$`reorderQuantity`)) {
        ProductUpdateObject[["reorderQuantity"]] <-
          self$`reorderQuantity`
      }
      if (!is.null(self$`salePrice`)) {
        ProductUpdateObject[["salePrice"]] <-
          self$`salePrice`
      }
      if (!is.null(self$`shippingPrice`)) {
        ProductUpdateObject[["shippingPrice"]] <-
          self$`shippingPrice`
      }
      if (!is.null(self$`shippingRequiresInsurance`)) {
        ProductUpdateObject[["shippingRequiresInsurance"]] <-
      ...
      if (!is.null(self$`stockQuantity`)) {
        ProductUpdateObject[["stockQuantity"]] <-
          self$`stockQuantity`
      }
      ...
      if (!is.null(self$`taxPrice`)) {
        ProductUpdateObject[["taxPrice"]] <-
          self$`taxPrice`
      }
      if (!is.null(self$`trackBatch`)) {
        ProductUpdateObject[["trackBatch"]] <-
          self$`trackBatch`
      }
      if (!is.null(self$`trackSerial`)) {
        ProductUpdateObject[["trackSerial"]] <-
          self$`trackSerial`
      }
      if (!is.null(self$`unit`)) {
        ProductUpdateObject[["unit"]] <-
          self$extractSimpleType(self$`unit`)
      }
      if (!is.null(self$`weightUnit`)) {
        ProductUpdateObject[["weightUnit"]] <-
          self$`weightUnit`
      }
      if (!is.null(self$`weightValue`)) {
        ProductUpdateObject[["weightValue"]] <-
          self$`weightValue`
      }
