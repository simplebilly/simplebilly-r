#' Create a new AnlageGKfzHinweis
#'
#' @description
#' AnlageGKfzHinweis Class
#'
#' @docType class
#' @title AnlageGKfzHinweis
#' @description AnlageGKfzHinweis Class
...
AnlageGKfzHinweis <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AnlageGKfzHinweis class.
    #'
    ...
    #'
    #' @return AnlageGKfzHinweis as a base R list.
    #' @examples
    #' # convert array of AnlageGKfzHinweis (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AnlageGKfzHinweis to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AnlageGKfzHinweisObject <- list()
      if (!is.null(self$`bezeichnung`)) {
        AnlageGKfzHinweisObject[["bezeichnung"]] <-
          self$`bezeichnung`
      }
      if (!is.null(self$`kennzeichen`)) {
        AnlageGKfzHinweisObject[["kennzeichen"]] <-
          self$`kennzeichen`
      }
      if (!is.null(self$`privat_anteil_prozent`)) {
        AnlageGKfzHinweisObject[["privat_anteil_prozent"]] <-
          self$`privat_anteil_prozent`
      }
      return(AnlageGKfzHinweisObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AnlageGKfzHinweis
    #'
    #' @param input_json the JSON input
    #' @return the instance of AnlageGKfzHinweis
    ...
    #' @return AnlageGKfzHinweis in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AnlageGKfzHinweis and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`bezeichnung`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnlageGKfzHinweis: the required field `bezeichnung` is missing."))
      }
      ...
      if (!is.null(input_json$`kennzeichen`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnlageGKfzHinweis: the required field `kennzeichen` is missing."))
      }
      ...
      if (!is.null(input_json$`privat_anteil_prozent`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AnlageGKfzHinweis: the required field `privat_anteil_prozent` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AnlageGKfzHinweis
    toString = function() {
      self$toJSONString()
    },
...
# AnlageGKfzHinweis$unlock()
#
## Below is an example to define the print function
# AnlageGKfzHinweis$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AnlageGKfzHinweis$lock()
