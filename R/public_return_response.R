#' Create a new PublicReturnResponse
#'
#' @description
#' PublicReturnResponse Class
#'
#' @docType class
#' @title PublicReturnResponse
#' @description PublicReturnResponse Class
...
#' @export
PublicReturnResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PublicReturnResponse class.
    #'
    ...
    #'
    #' @return PublicReturnResponse as a base R list.
    #' @examples
    #' # convert array of PublicReturnResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PublicReturnResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PublicReturnResponseObject <- list()
      if (!is.null(self$`createdAt`)) {
        PublicReturnResponseObject[["createdAt"]] <-
          self$`createdAt`
      }
      if (!is.null(self$`items`)) {
        PublicReturnResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`notes`)) {
        PublicReturnResponseObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`orderNumber`)) {
        PublicReturnResponseObject[["orderNumber"]] <-
          self$`orderNumber`
      }
      if (!is.null(self$`returnNumber`)) {
        PublicReturnResponseObject[["returnNumber"]] <-
          self$`returnNumber`
      }
      if (!is.null(self$`returnOrderId`)) {
        PublicReturnResponseObject[["returnOrderId"]] <-
          self$`returnOrderId`
      }
      if (!is.null(self$`status`)) {
        PublicReturnResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`updatedAt`)) {
        PublicReturnResponseObject[["updatedAt"]] <-
          self$`updatedAt`
      }
      return(PublicReturnResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PublicReturnResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PublicReturnResponse
    ...
    #' @return PublicReturnResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PublicReturnResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`createdAt`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PublicReturnResponse: the required field `createdAt` is missing."))
      }
      # check the required field `items`
      if (!is.null(input_json$`items`)) {
        stopifnot(R6::is.R6(input_json$`items`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for PublicReturnResponse: the required field `items` is missing."))
      }
      ...
      if (!is.null(input_json$`returnNumber`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PublicReturnResponse: the required field `returnNumber` is missing."))
      }
      ...
      if (!is.null(input_json$`returnOrderId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PublicReturnResponse: the required field `returnOrderId` is missing."))
      }
      ...
      if (!is.null(input_json$`status`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PublicReturnResponse: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PublicReturnResponse
    toString = function() {
      self$toJSONString()
    },
...
# PublicReturnResponse$unlock()
#
## Below is an example to define the print function
# PublicReturnResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PublicReturnResponse$lock()
