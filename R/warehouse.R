...
Warehouse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Warehouse class.
    #'
    #' @param code code
    #' @param name name
    ...
    #'
    #' @return Warehouse as a base R list.
    #' @examples
    #' # convert array of Warehouse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of Warehouse
    #'
    #' @param input_json the JSON input
    #' @return the instance of Warehouse
    ...
    #' @return Warehouse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to Warehouse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Warehouse: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Warehouse: the required field `name` is missing."))
      }
    },
...
# Warehouse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
