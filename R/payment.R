...
Payment <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Payment class.
    #'
    #' @param amount amount
    ...
    #'
    #' @return Payment as a base R list.
    #' @examples
    #' # convert array of Payment (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert Payment to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of Payment
    #'
    #' @param input_json the JSON input
    #' @return the instance of Payment
    ...
    #' @description
    #' Validate JSON input with respect to Payment and throw an exception if invalid
    #'
...
# Payment$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
