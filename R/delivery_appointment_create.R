#' Create a new DeliveryAppointmentCreate
#'
#' @description
#' DeliveryAppointmentCreate Class
#'
#' @docType class
#' @title DeliveryAppointmentCreate
#' @description DeliveryAppointmentCreate Class
...
#' @export
DeliveryAppointmentCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DeliveryAppointmentCreate class.
    #'
    #' @param email email
    ...
    #'
    #' @return DeliveryAppointmentCreate as a base R list.
    #' @examples
    #' # convert array of DeliveryAppointmentCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeliveryAppointmentCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeliveryAppointmentCreateObject <- list()
      if (!is.null(self$`email`)) {
        DeliveryAppointmentCreateObject[["email"]] <-
          self$`email`
      }
      if (!is.null(self$`notes`)) {
        DeliveryAppointmentCreateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`phone`)) {
        DeliveryAppointmentCreateObject[["phone"]] <-
          self$`phone`
      }
      if (!is.null(self$`requestedDate`)) {
        DeliveryAppointmentCreateObject[["requestedDate"]] <-
          self$`requestedDate`
      }
      if (!is.null(self$`status`)) {
        DeliveryAppointmentCreateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`supplierName`)) {
        DeliveryAppointmentCreateObject[["supplierName"]] <-
          self$`supplierName`
      }
      if (!is.null(self$`timeSlot`)) {
        DeliveryAppointmentCreateObject[["timeSlot"]] <-
          self$`timeSlot`
      }
      if (!is.null(self$`warehouseId`)) {
        DeliveryAppointmentCreateObject[["warehouseId"]] <-
          self$`warehouseId`
      }
      return(DeliveryAppointmentCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of DeliveryAppointmentCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeliveryAppointmentCreate
    ...
    #' @return DeliveryAppointmentCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DeliveryAppointmentCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`email`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryAppointmentCreate: the required field `email` is missing."))
      }
      ...
      if (!is.null(input_json$`requestedDate`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryAppointmentCreate: the required field `requestedDate` is missing."))
      }
      # check the required field `status`
      if (!is.null(input_json$`status`)) {
        stopifnot(R6::is.R6(input_json$`status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for DeliveryAppointmentCreate: the required field `status` is missing."))
      }
      ...
      if (!is.null(input_json$`supplierName`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryAppointmentCreate: the required field `supplierName` is missing."))
      }
      ...
      if (!is.null(input_json$`warehouseId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryAppointmentCreate: the required field `warehouseId` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DeliveryAppointmentCreate
    toString = function() {
      self$toJSONString()
    },
...
# DeliveryAppointmentCreate$unlock()
#
## Below is an example to define the print function
# DeliveryAppointmentCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DeliveryAppointmentCreate$lock()
