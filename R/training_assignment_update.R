#' Create a new TrainingAssignmentUpdate
#'
#' @description
#' TrainingAssignmentUpdate Class
#'
#' @docType class
#' @title TrainingAssignmentUpdate
#' @description TrainingAssignmentUpdate Class
...
#' @export
TrainingAssignmentUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TrainingAssignmentUpdate class.
    #'
    ...
    #'
    #' @return TrainingAssignmentUpdate as a base R list.
    #' @examples
    #' # convert array of TrainingAssignmentUpdate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TrainingAssignmentUpdate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TrainingAssignmentUpdateObject <- list()
      if (!is.null(self$`assignedBy`)) {
        TrainingAssignmentUpdateObject[["assignedBy"]] <-
          self$`assignedBy`
      }
      if (!is.null(self$`dueDate`)) {
        TrainingAssignmentUpdateObject[["dueDate"]] <-
          self$`dueDate`
      }
      if (!is.null(self$`employeeId`)) {
        TrainingAssignmentUpdateObject[["employeeId"]] <-
          self$`employeeId`
      }
      if (!is.null(self$`notes`)) {
        TrainingAssignmentUpdateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`status`)) {
        TrainingAssignmentUpdateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      if (!is.null(self$`trainingId`)) {
        TrainingAssignmentUpdateObject[["trainingId"]] <-
          self$`trainingId`
      }
      return(TrainingAssignmentUpdateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of TrainingAssignmentUpdate
    #'
    #' @param input_json the JSON input
    #' @return the instance of TrainingAssignmentUpdate
    ...
    #' @return TrainingAssignmentUpdate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TrainingAssignmentUpdate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of TrainingAssignmentUpdate
    toString = function() {
      self$toJSONString()
    },
...
# TrainingAssignmentUpdate$unlock()
#
## Below is an example to define the print function
# TrainingAssignmentUpdate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TrainingAssignmentUpdate$lock()
