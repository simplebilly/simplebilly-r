#' Create a new KycRecordCreate
#'
#' @description
#' KycRecordCreate Class
#'
#' @docType class
#' @title KycRecordCreate
#' @description KycRecordCreate Class
...
KycRecordCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new KycRecordCreate class.
    #'
    ...
    #'
    #' @return KycRecordCreate as a base R list.
    #' @examples
    #' # convert array of KycRecordCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert KycRecordCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      KycRecordCreateObject <- list()
      if (!is.null(self$`customerId`)) {
        KycRecordCreateObject[["customerId"]] <-
          self$`customerId`
      }
      if (!is.null(self$`customerName`)) {
        KycRecordCreateObject[["customerName"]] <-
          self$`customerName`
      }
      if (!is.null(self$`kycDate`)) {
        KycRecordCreateObject[["kycDate"]] <-
          self$`kycDate`
      }
      if (!is.null(self$`notes`)) {
        KycRecordCreateObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`retentionUntil`)) {
        KycRecordCreateObject[["retentionUntil"]] <-
          self$`retentionUntil`
      }
      if (!is.null(self$`riskAssessment`)) {
        KycRecordCreateObject[["riskAssessment"]] <-
          self$`riskAssessment`
      }
      return(KycRecordCreateObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of KycRecordCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of KycRecordCreate
    ...
    #' @return KycRecordCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to KycRecordCreate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of KycRecordCreate
    toString = function() {
      self$toJSONString()
    },
...
# KycRecordCreate$unlock()
#
## Below is an example to define the print function
# KycRecordCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# KycRecordCreate$lock()
