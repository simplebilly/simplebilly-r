#' Create a new DeliveryDateCreate
#'
#' @description
#' DeliveryDateCreate Class
#'
#' @docType class
#' @title DeliveryDateCreate
#' @description DeliveryDateCreate Class
...
#' @field orderNumber Sales order number (`order.order_number`). character
...
#' @field promisedDate Date promised to the customer. character
#' @field status One of: promised | confirmed | rescheduled | fulfilled | late | cancelled \link{DeliveryDateStatus}
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
DeliveryDateCreate <- R6::R6Class(
  "DeliveryDateCreate",
  public = list(
    `customerId` = NULL,
    `fulfilledDate` = NULL,
    ...
    #' @description
    #' Initialize a new DeliveryDateCreate class.
    #'
    ...
    initialize = function(`orderNumber`, `promisedDate`, `status`, `customerId` = NULL, `fulfilledDate` = NULL, `note` = NULL, `originalDate` = NULL, `productId` = NULL, ...) {
      ...
      if (!missing(`promisedDate`)) {
        if (!(is.character(`promisedDate`) && length(`promisedDate`) == 1)) {
    ...
    #'
    #' @return DeliveryDateCreate as a base R list.
    #' @examples
    #' # convert array of DeliveryDateCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeliveryDateCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeliveryDateCreateObject <- list()
      if (!is.null(self$`customerId`)) {
        DeliveryDateCreateObject[["customerId"]] <-
          self$`customerId`
      }
      if (!is.null(self$`fulfilledDate`)) {
        DeliveryDateCreateObject[["fulfilledDate"]] <-
          self$`fulfilledDate`
      }
      if (!is.null(self$`note`)) {
        DeliveryDateCreateObject[["note"]] <-
          self$`note`
      }
      if (!is.null(self$`orderNumber`)) {
        DeliveryDateCreateObject[["orderNumber"]] <-
          self$`orderNumber`
      }
      if (!is.null(self$`originalDate`)) {
        DeliveryDateCreateObject[["originalDate"]] <-
          self$`originalDate`
      }
      if (!is.null(self$`productId`)) {
        DeliveryDateCreateObject[["productId"]] <-
          self$`productId`
      }
      if (!is.null(self$`promisedDate`)) {
        DeliveryDateCreateObject[["promisedDate"]] <-
          self$`promisedDate`
      }
      if (!is.null(self$`status`)) {
        DeliveryDateCreateObject[["status"]] <-
          self$extractSimpleType(self$`status`)
      }
      return(DeliveryDateCreateObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of DeliveryDateCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeliveryDateCreate
    ...
    #' @return DeliveryDateCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DeliveryDateCreate and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`orderNumber`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeliveryDateCreate: the required field `orderNumber` is missing."))
      }
      # check the required field `promisedDate`
      if (!is.null(input_json$`promisedDate`)) {
        if (!(is.character(input_json$`promisedDate`) && length(input_json$`promisedDate`) == 1)) {
          stop(paste("Error! Invalid data for `promisedDate`. Must be a string:", input_json$`promisedDate`))
        }
      } else {
        stop(paste("The JSON input `", input, "` is invalid for DeliveryDateCreate: the required field `promisedDate` is missing."))
      }
      # check the required field `status`
      if (!is.null(input_json$`status`)) {
        stopifnot(R6::is.R6(input_json$`status`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for DeliveryDateCreate: the required field `status` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DeliveryDateCreate
    toString = function() {
      self$toJSONString()
    },
    ...
    isValid = function() {
      ...
      # check if the required `promisedDate` is null
      if (is.null(self$`promisedDate`)) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      # check if the required `promisedDate` is null
      if (is.null(self$`promisedDate`)) {
        invalid_fields["promisedDate"] <- "Non-nullable required field `promisedDate` cannot be null."
      }
...
# DeliveryDateCreate$unlock()
#
## Below is an example to define the print function
# DeliveryDateCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DeliveryDateCreate$lock()
