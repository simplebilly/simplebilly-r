...
#'
#' @docType class
#' @title Ebilanz operations
#' @description EbilanzApi
...
#' @export
EbilanzApi <- R6::R6Class(
  "EbilanzApi",
  public = list(
    api_client = NULL,

    #' @description
    #' Initialize a new EbilanzApi.
    #'
    ...
    EbilanzReportApi = function(year = NULL, date_from = NULL, date_to = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$EbilanzReportApiWithHttpInfo(year, date_from, date_to, data_file = data_file, ..., .parse = .parse)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (EBilanzReport) with additional information such as HTTP status code, headers
    EbilanzReportApiWithHttpInfo = function(year = NULL, date_from = NULL, date_to = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/api/v1/bookkeeping/ebilanz"
      # Bearer token
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "EBilanzReport"),
          error = function(e) {
    ...
    #'
    #' @return void
    EbilanzXbrlExportApi = function(year = NULL, date_from = NULL, date_to = NULL, ...) {
      local_var_response <- self$EbilanzXbrlExportApiWithHttpInfo(year, date_from, date_to, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    EbilanzXbrlExportApiWithHttpInfo = function(year = NULL, date_from = NULL, date_to = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/api/v1/bookkeeping/ebilanz/xbrl"
      # Bearer token
      if (!is.null(self$api_client$bearer_token)) {
        header_params["Authorization"] <- paste("Bearer", self$api_client$bearer_token, sep = " ")
      }
