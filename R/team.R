...
Team <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return Team as a base R list.
    #' @examples
    #' # convert array of Team (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`parent_team_id`)) {
        TeamObject[["parent_team_id"]] <-
          self$`parent_team_id`
      }
      if (!is.null(self$`tenant_id`)) {
        TeamObject[["tenant_id"]] <-
          self$`tenant_id`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of Team
    #'
    #' @param input_json the JSON input
    #' @return the instance of Team
    ...
    #' @description
    #' Validate JSON input with respect to Team and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`created_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Team: the required field `created_at` is missing."))
      }
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Team: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Team: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`tenant_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Team: the required field `tenant_id` is missing."))
      }
      ...
      if (!is.null(input_json$`updated_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Team: the required field `updated_at` is missing."))
      }
    },
...
# Team$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
