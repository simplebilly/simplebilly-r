#' Create a new DatevExportResponse
#'
#' @description
#' DatevExportResponse Class
#'
#' @docType class
#' @title DatevExportResponse
#' @description DatevExportResponse Class
...
#' @export
DatevExportResponse <- R6::R6Class(
  "DatevExportResponse",
  public = list(
    `booking_count` = NULL,
    `csv_content` = NULL,
    ...
    #' @description
    #' Initialize a new DatevExportResponse class.
    #'
    ...
    #'
    #' @return DatevExportResponse as a base R list.
    #' @examples
    #' # convert array of DatevExportResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DatevExportResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DatevExportResponseObject <- list()
      if (!is.null(self$`booking_count`)) {
        DatevExportResponseObject[["booking_count"]] <-
          self$`booking_count`
      }
      if (!is.null(self$`csv_content`)) {
        DatevExportResponseObject[["csv_content"]] <-
          self$`csv_content`
      }
      if (!is.null(self$`filename`)) {
        DatevExportResponseObject[["filename"]] <-
          self$`filename`
      }
      return(DatevExportResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of DatevExportResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of DatevExportResponse
    ...
    #' @return DatevExportResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DatevExportResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`booking_count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatevExportResponse: the required field `booking_count` is missing."))
      }
      ...
      if (!is.null(input_json$`csv_content`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatevExportResponse: the required field `csv_content` is missing."))
      }
      ...
      if (!is.null(input_json$`filename`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatevExportResponse: the required field `filename` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DatevExportResponse
    toString = function() {
      self$toJSONString()
    },
...
# DatevExportResponse$unlock()
#
## Below is an example to define the print function
# DatevExportResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DatevExportResponse$lock()
