...
#' @field productId The parent product this variant belongs to. References the product entity. character [optional]
#' @field sku Variant-specific SKU (must be unique per tenant). character [optional]
...
ProductVariantUpdate <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`barcode` = NULL, `imageLink` = NULL, `isActive` = NULL, `name` = NULL, `optionValues` = NULL, `price` = NULL, `priceDelta` = NULL, `productId` = NULL, `sku` = NULL, `stockQuantity` = NULL, ...) {
      if (!is.null(`barcode`)) {
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`imageLink`)) {
        ProductVariantUpdateObject[["imageLink"]] <-
          self$`imageLink`
      }
      if (!is.null(self$`isActive`)) {
        ProductVariantUpdateObject[["isActive"]] <-
          self$`isActive`
      }
      ...
      if (!is.null(self$`optionValues`)) {
        ProductVariantUpdateObject[["optionValues"]] <-
      ...
      if (!is.null(self$`priceDelta`)) {
        ProductVariantUpdateObject[["priceDelta"]] <-
          self$`priceDelta`
      }
      if (!is.null(self$`productId`)) {
        ProductVariantUpdateObject[["productId"]] <-
          self$`productId`
      }
      if (!is.null(self$`sku`)) {
      ...
      if (!is.null(self$`stockQuantity`)) {
        ProductVariantUpdateObject[["stockQuantity"]] <-
          self$`stockQuantity`
      }
