#' Create a new PayGapExportResponse
#'
#' @description
#' PayGapExportResponse Class
#'
#' @docType class
#' @title PayGapExportResponse
#' @description PayGapExportResponse Class
...
#' @export
PayGapExportResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PayGapExportResponse class.
    #'
    ...
    #'
    #' @return PayGapExportResponse as a base R list.
    #' @examples
    #' # convert array of PayGapExportResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PayGapExportResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PayGapExportResponseObject <- list()
      if (!is.null(self$`csv_content`)) {
        PayGapExportResponseObject[["csv_content"]] <-
          self$`csv_content`
      }
      if (!is.null(self$`filename`)) {
        PayGapExportResponseObject[["filename"]] <-
          self$`filename`
      }
      return(PayGapExportResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PayGapExportResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PayGapExportResponse
    ...
    #' @return PayGapExportResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PayGapExportResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`csv_content`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PayGapExportResponse: the required field `csv_content` is missing."))
      }
      ...
      if (!is.null(input_json$`filename`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PayGapExportResponse: the required field `filename` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PayGapExportResponse
    toString = function() {
      self$toJSONString()
    },
...
# PayGapExportResponse$unlock()
#
## Below is an example to define the print function
# PayGapExportResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PayGapExportResponse$lock()
