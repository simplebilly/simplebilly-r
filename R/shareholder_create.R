#' Create a new ShareholderCreate
#'
#' @description
#' ShareholderCreate Class
#'
#' @docType class
#' @title ShareholderCreate
#' @description ShareholderCreate Class
...
ShareholderCreate <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ShareholderCreate class.
    #'
    ...
    #'
    #' @return ShareholderCreate as a base R list.
    #' @examples
    #' # convert array of ShareholderCreate (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ShareholderCreate to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ShareholderCreateObject <- list()
      if (!is.null(self$`address`)) {
        ShareholderCreateObject[["address"]] <-
          self$`address`
      }
      if (!is.null(self$`birthDate`)) {
        ShareholderCreateObject[["birthDate"]] <-
          self$`birthDate`
      }
      if (!is.null(self$`email`)) {
        ShareholderCreateObject[["email"]] <-
          self$`email`
      }
      if (!is.null(self$`firstName`)) {
        ShareholderCreateObject[["firstName"]] <-
          self$`firstName`
      }
      if (!is.null(self$`lastName`)) {
        ShareholderCreateObject[["lastName"]] <-
          self$`lastName`
      }
      if (!is.null(self$`shareNumber`)) {
        ShareholderCreateObject[["shareNumber"]] <-
          self$`shareNumber`
      }
      if (!is.null(self$`shares`)) {
        ShareholderCreateObject[["shares"]] <-
          self$`shares`
      }
      return(ShareholderCreateObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ShareholderCreate
    #'
    #' @param input_json the JSON input
    #' @return the instance of ShareholderCreate
    ...
    #' @return ShareholderCreate in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ShareholderCreate and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ShareholderCreate
    toString = function() {
      self$toJSONString()
    },
...
# ShareholderCreate$unlock()
#
## Below is an example to define the print function
# ShareholderCreate$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ShareholderCreate$lock()
